        ...
        <div className="flex gap-0.5 sm:gap-1">
          {[1, 2, 3, 4, 5].map((star) => (
            <button
              ...
              className="cursor-pointer p-2 transition-transform duration-150 ease-out active:scale-[0.96] motion-reduce:active:scale-100 disabled:cursor-not-allowed sm:p-1.5"
              disabled={disabled}
