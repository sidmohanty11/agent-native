const messages = {
  ...
  designSystemSetup: {
    ...
    figParseFailed: "تعذر تحليل ملف Figma هذا.",
    figmaCreated: "تم إنشاء نظام التصميم من Figma",
    createFailed: "تعذر إنشاء نظام التصميم",
    ...
    figmaFile: "ملف Figma",
    parsingFigmaFile: "جارٍ تحليل ملف Figma...",
    uploadFigDescription: "ارفع نسخة .fig محلية لإنشاء نظام تصميم للشرائح",
    ...
    colorText: "النص",
    figmaThumbnailAlt: "صورة مصغرة لملف Figma",
    designSystemName: "اسم نظام التصميم",
    brandNamePlaceholder: "اسم العلامة",
    figPreviewStats: "{{nodes}}، {{gradients}}، {{images}}",
    nodeCount_zero: "{{formattedCount}} عقدة",
    nodeCount_one: "{{formattedCount}} عقدة",
    nodeCount_two: "{{formattedCount}} عقدتان",
    nodeCount_few: "{{formattedCount}} عقد",
    nodeCount_many: "{{formattedCount}} عقدة",
    nodeCount_other: "{{formattedCount}} عقدة",
    gradientCount_zero: "{{formattedCount}} تدرج",
    gradientCount_one: "{{formattedCount}} تدرج",
    gradientCount_two: "{{formattedCount}} تدرجان",
    gradientCount_few: "{{formattedCount}} تدرجات",
    gradientCount_many: "{{formattedCount}} تدرجًا",
    gradientCount_other: "{{formattedCount}} تدرج",
    imageCount_zero: "{{formattedCount}} صورة",
    imageCount_one: "{{formattedCount}} صورة",
    imageCount_two: "{{formattedCount}} صورتان",
    imageCount_few: "{{formattedCount}} صور",
    imageCount_many: "{{formattedCount}} صورة",
    imageCount_other: "{{formattedCount}} صورة",
