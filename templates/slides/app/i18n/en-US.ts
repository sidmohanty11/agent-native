const messages = {
  ...
  designSystemSetup: {
    ...
    figParseFailed: "Could not parse that Figma file.",
    figmaCreated: "Design system created from Figma",
    createFailed: "Could not create the design system",
    ...
    parsingFigmaFile: "Parsing Figma file...",
    uploadFigDescription:
      "Upload a .fig local copy to create a slide design system",
    ...
    nodeCount_one: "{{formattedCount}} node",
    nodeCount_other: "{{formattedCount}} nodes",
    gradientCount_one: "{{formattedCount}} gradient",
    gradientCount_other: "{{formattedCount}} gradients",
