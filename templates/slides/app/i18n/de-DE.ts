const messages = {
  ...
  designSystemSetup: {
    ...
    figParseFailed: "Diese Figma-Datei konnte nicht analysiert werden.",
    figmaCreated: "Designsystem aus Figma erstellt",
    createFailed: "Designsystem konnte nicht erstellt werden",
    ...
    parsingFigmaFile: "Figma-Datei wird analysiert...",
    uploadFigDescription:
      "Lade eine lokale .fig-Kopie hoch, um ein Folien-Designsystem zu erstellen",
    ...
    nodeCount_one: "{{formattedCount}} Knoten",
    nodeCount_other: "{{formattedCount}} Knoten",
    gradientCount_one: "{{formattedCount}} Verlauf",
    gradientCount_other: "{{formattedCount}} Verläufe",
    imageCount_one: "{{formattedCount}} Bild",
    imageCount_other: "{{formattedCount}} Bilder",
