const messages = {
  ...
  designSystemSetup: {
    ...
    figParseFailed: "无法解析该 Figma 文件。",
    figmaCreated: "已从 Figma 创建设计系统",
    createFailed: "无法创建设计系统",
    genericError: "出了点问题",
    updated: "设计系统已更新",
    updateFailed: "更新失败",
    ...
    figmaFile: "Figma 文件",
    parsingFigmaFile: "正在解析 Figma 文件...",
    uploadFigDescription: "上传 .fig 本地副本以创建幻灯片设计系统",
    websiteUrl: "网站 URL",
    ...
    nodeCount_other: "{{formattedCount}} 个节点",
    gradientCount_other: "{{formattedCount}} 个渐变",
    imageCount_other: "{{formattedCount}} 张图片",
    headingsLabel: "标题：",
    bodyLabel: "正文：",
    creating: "正在创建...",
