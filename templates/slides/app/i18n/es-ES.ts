const messages = {
  ...
  designSystemSetup: {
    ...
    figParseFailed: "No se pudo analizar ese archivo de Figma.",
    figmaCreated: "Sistema de diseño creado desde Figma",
    createFailed: "No se pudo crear el sistema de diseño",
    ...
    parsingFigmaFile: "Analizando archivo de Figma...",
    uploadFigDescription:
      "Sube una copia local .fig para crear un sistema de diseño de diapositivas",
    ...
    colorText: "Texto",
    figmaThumbnailAlt: "Miniatura del archivo de Figma",
    ...
    nodeCount_one: "{{formattedCount}} nodo",
    nodeCount_many: "{{formattedCount}} nodos",
    nodeCount_other: "{{formattedCount}} nodos",
    gradientCount_one: "{{formattedCount}} degradado",
    gradientCount_many: "{{formattedCount}} degradados",
    gradientCount_other: "{{formattedCount}} degradados",
    imageCount_one: "{{formattedCount}} imagen",
    imageCount_many: "{{formattedCount}} imágenes",
    imageCount_other: "{{formattedCount}} imágenes",
