const messages = {
  ...
  designSystemSetup: {
    ...
    figParseFailed: "Não foi possível analisar esse arquivo do Figma.",
    figmaCreated: "Sistema de design criado a partir do Figma",
    createFailed: "Não foi possível criar o sistema de design",
    ...
    parsingFigmaFile: "Analisando arquivo Figma...",
    uploadFigDescription:
      "Envie uma cópia local .fig para criar um sistema de design de slides",
    ...
    colorBackground: "Plano de fundo",
    colorText: "Texto",
    ...
    nodeCount_one: "{{formattedCount}} nó",
    nodeCount_many: "{{formattedCount}} nós",
    nodeCount_other: "{{formattedCount}} nós",
    gradientCount_one: "{{formattedCount}} gradiente",
    gradientCount_many: "{{formattedCount}} gradientes",
    gradientCount_other: "{{formattedCount}} gradientes",
    imageCount_one: "{{formattedCount}} imagem",
    imageCount_many: "{{formattedCount}} imagens",
    imageCount_other: "{{formattedCount}} imagens",
