const messages = {
  ...
  designSystemSetup: {
    ...
    figParseFailed: "その Figma ファイルを解析できませんでした。",
    figmaCreated: "Figma からデザインシステムを作成しました",
    createFailed: "デザインシステムを作成できませんでした",
    ...
    parsingFigmaFile: "Figma ファイルを解析中...",
    uploadFigDescription:
      ".fig のローカルコピーをアップロードしてスライド用デザインシステムを作成",
    ...
    nodeCount_other: "{{formattedCount}} ノード",
    gradientCount_other: "{{formattedCount}} グラデーション",
    imageCount_other: "{{formattedCount}} 画像",
    headingsLabel: "見出し:",
    bodyLabel: "本文:",
    creating: "作成中...",
