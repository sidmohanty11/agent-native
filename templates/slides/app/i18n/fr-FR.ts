const messages = {
  ...
  designSystemSetup: {
    ...
    figParseFailed: "Impossible d’analyser ce fichier Figma.",
    figmaCreated: "Système de design créé depuis Figma",
    createFailed: "Impossible de créer le système de design",
    ...
    parsingFigmaFile: "Analyse du fichier Figma...",
    uploadFigDescription:
      "Téléversez une copie locale .fig pour créer un système de design de diapositives",
    ...
    colorText: "Texte",
    figmaThumbnailAlt: "Miniature du fichier Figma",
    designSystemName: "Nom du système de design",
    brandNamePlaceholder: "Nom de la marque",
    figPreviewStats: "{{nodes}}, {{gradients}}, {{images}}",
    nodeCount_one: "{{formattedCount}} nœud",
    nodeCount_many: "{{formattedCount}} nœuds",
    nodeCount_other: "{{formattedCount}} nœuds",
    gradientCount_one: "{{formattedCount}} dégradé",
    gradientCount_many: "{{formattedCount}} dégradés",
    gradientCount_other: "{{formattedCount}} dégradés",
    imageCount_one: "{{formattedCount}} image",
    imageCount_many: "{{formattedCount}} images",
    imageCount_other: "{{formattedCount}} images",
    headingsLabel: "Titres :",
    bodyLabel: "Corps :",
    creating: "Création...",
    createDesignSystem: "Créer le système de design",
