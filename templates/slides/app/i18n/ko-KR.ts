const messages = {
  ...
  designSystemSetup: {
    ...
    figParseFailed: "해당 Figma 파일을 분석할 수 없습니다.",
    figmaCreated: "Figma에서 디자인 시스템을 만들었습니다",
    createFailed: "디자인 시스템을 만들 수 없습니다",
    ...
    figmaFile: "Figma 파일",
    parsingFigmaFile: "Figma 파일 분석 중...",
    uploadFigDescription:
      ".fig 로컬 사본을 업로드해 슬라이드 디자인 시스템 만들기",
    websiteUrl: "웹사이트 URL",
    ...
    nodeCount_other: "노드 {{formattedCount}}개",
    gradientCount_other: "그라디언트 {{formattedCount}}개",
    imageCount_other: "이미지 {{formattedCount}}개",
    headingsLabel: "제목:",
    bodyLabel: "본문:",
    creating: "생성 중...",
