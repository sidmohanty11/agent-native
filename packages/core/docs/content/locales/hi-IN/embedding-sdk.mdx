...
<Diagram id="doc-block-dp2jx4" title={"एम्बेडिंग झिल्ली"} summary={"होस्ट ऐप सर्वर-साइड ऑथ और लाइव पेज संदर्भ प्रदान करता है; Agent-Native टिकाऊ साइडकार चलाता है और क्लाइंट क्रियाओं और होस्ट कमांड के माध्यम से खुले टैब तक पहुंचता है।"}>

```html
<div class="diagram-embed">
  <div class="diagram-box" data-rough>
    <strong>होस्ट SaaS ऐप</strong
    ><small class="diagram-muted">आपका UI, आपका auth</small>
  </div>
  <div class="diagram-col">
    <div class="diagram-pill accent">getContext &rarr;</div>
    <div class="diagram-pill">&larr; क्लाइंट actions</div>
    <div class="diagram-pill">&larr; होस्ट commands</div>
  </div>
  <div class="diagram-panel center" data-rough>
    <strong>Agent-Native sidecar</strong
    ><small class="diagram-muted">टिकाऊ चैट · ऐप स्थिति · एक्सटेंशन</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-box" data-rough>
    SQL<br /><small class="diagram-muted">framework तालिकाएँ</small>
  </div>
</div>
```
...
<Diagram id="doc-block-qxjcvj" title={"सर्वर-मध्यस्थ ब्राउज़र-सत्र ब्रिज"} summary={"एक बैकएंड टूल काम को कतारबद्ध करता है; पंजीकृत टैब इसका दावा करता है, इसे लाइव पेज पर चलाता है, और परिणाम एजेंट को लौटाता है - इसलिए backend/Slack/A2A एजेंट अभी भी खुले टैब को छू सकता है।"}>

```html
<div class="diagram-bridge">
  <div class="diagram-node" data-rough>
    बैकएंड एजेंट<br /><small class="diagram-muted">चैट · Slack · A2A</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-box" data-rough>
  ...
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-node" data-rough>
    लाइव टैब इसे claim करता है<br /><small class="diagram-muted"
