...
<AnnotatedCode
  id="doc-block-1ia1amd"
  title={"एक परिणामी कार्रवाई गेटिंग"}
  ...
  annotations={[
    {
      lines: "10",
      label: "पूरी सड़क",
      note: "एक झंडा. इसके सत्य होने और कॉल अस्वीकृत होने पर, लूप `run` से पहले बंद हो जाता है - मॉडल कभी भी अपने आप साइड इफेक्ट तक नहीं पहुंचता है।",
    },
    {
      lines: "11-13",
      label: "run() is untouched",
      note: "हैंडलर वही रहता है। अनुमोदन इसके चारों ओर लूप द्वारा लागू किया जाता है, `run` के अंदर किसी चीज़ द्वारा नहीं।",
    },
  ]}
/>
...
<Diagram id="doc-block-fxub02" title={"अनुमोदन में रुकावट"} summary={"एक गेटेड कॉल रन() सक्रिय होने से पहले टर्न को रोक देती है। अनुमोदन कॉल की कुंजी ले जाने वाले टर्न को फिर से जारी करता है; तभी दुष्प्रभाव होता है।"}>

```html
<div class="diagram-approve">
  <div class="diagram-box" data-rough>एजेंट send-email कॉल करता है</div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&darr;</div>
  <div class="diagram-panel warn" data-rough>
    <strong>Gate truthy है, कॉल अभी approved नहीं</strong
  ...
  <div class="diagram-box" data-rough>
    मानव चैट में Approve क्लिक करता है<br /><small class="diagram-muted"
      >क्लाइंट approvedToolCalls: [approvalKey] के साथ टर्न फिर जारी करता
      है</small
    >
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&darr;</div>
