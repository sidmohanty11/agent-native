...
<Diagram id="doc-block-1r6bjnp" title={"सतह स्पेक्ट्रम"} summary={"एक क्रिया सतह, चार उत्पाद आकार - प्रत्येक नीचे के ऑपरेशन को बदले बिना यूआई जोड़ता है।"}>

```html
<div class="diagram-spectrum">
  <div class="diagram-card">
    <strong>Headless</strong
    ><small class="diagram-muted">actions, jobs, scripts, दूसरे agents</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-card">
    <strong>rich chat</strong
    ><small class="diagram-muted">कंपोजर, ट्रांसक्रिप्ट, टूल कार्ड</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-card">
  ...
  <div class="diagram-card accent-card">
    <span class="diagram-pill accent">अधिकांश UI</span
    ><strong>पूर्ण application</strong
    ><small class="diagram-muted">स्थायी स्क्रीन, डेटा, सहयोग</small>
  </div>
</div>
<div class="diagram-base" data-rough>
  <span class="diagram-muted">वही actions · वही SQL · वही एजेंट लूप</span>
</div>
```
...
<Endpoint id="doc-block-oxu8e0" title={"HTTP पर एक कार्रवाई कॉल करना"} method="POST" path="/_agent-native/actions/summarize-week" summary={"HTTP पर नाम से कोई भी कार्रवाई शुरू करें"} request={{
...
<Diagram id="doc-block-8kn869" title={"साइडकार होस्ट ऐप से कैसे जुड़ता है"} summary={"प्लगइन Agent-Native रूट सर्वर-साइड को माउंट करता है; React साइडकार पेज संदर्भ को स्ट्रीम करता है और होस्ट कमांड को बाहर स्ट्रीम करता है।"}>
...
<div class="diagram-sidecar">
  <div class="diagram-panel">
    ...
    <div class="diagram-node">
      getContext()<br /><small class="diagram-muted">रूट · चयन</small>
    </div>
    <div class="diagram-node">
      onNavigate / onRefresh<br /><small class="diagram-muted"
        >होस्ट commands</small
      >
    </div>
  </div>
  ...
  <div class="diagram-panel accent-panel">
    ...
    <div class="diagram-box" data-rough>
      Agent-Native रूट<br /><small class="diagram-muted"
