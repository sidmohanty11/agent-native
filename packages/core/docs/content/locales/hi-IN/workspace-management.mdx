...
> **कौन सा कार्यक्षेत्र दस्तावेज़?** यह पृष्ठ **शासन** को कवर करता है - एक रेपो में कई ऐप्स की समीक्षा, अनुमोदन और स्वामित्व कौन करता है। एजेंट अनुकूलन परत (एजेंट संसाधन: `AGENTS.md`, मेमोरी, skills, कस्टम एजेंट) के लिए [Agent Resources](/docs/workspace) देखें; परिनियोजन आकार (एक मोनोरेपो, कई ऐप्स) के लिए [Multi-App Workspaces](/docs/multi-app-workspace) देखें।
...
संसाधन मॉडल और विहित पथों के लिए, [Agent Resources — Global resources](/docs/workspace#global-resources) देखें।
...
- [ ] फिर साझा प्रदाता खातों के लिए पुन: प्रयोज्य कार्यक्षेत्र कनेक्शन पंजीकृत करें
      ...
      वह खाता
- [ ] संसाधन पृष्ठ के माध्यम से कार्यक्षेत्र-व्यापी skills, रेलिंग निर्देश और ब्रांड/कंपनी संदर्भ संसाधन जोड़ें। संपूर्ण संसाधन-मॉडल तालिका और अनुशंसित स्टार्टर पैक के लिए [Agent Resources](/docs/workspace#global-resources) देखें।
