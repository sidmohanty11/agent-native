...
<Diagram id="doc-block-gdfyxv" title={"तीन मार्ग, एक बंडल"} summary={"यूनिवर्सल CLI, Claude Code प्लगइन, और Codex प्लगइन सभी समान दो कौशल और होस्टेड प्लान कनेक्टर स्थापित करते हैं।"}>
