...
<Diagram id="doc-block-1cxy6w9" title={"माता-पिता रहस्य रखते हैं; एडॉप्टर केवल कोड चलाता है"} summary={"रन-कोड मॉड्यूल बनाता है और लूपबैक ब्रिज चलाता है; एडॉप्टर एक गैर-गुप्त मॉड्यूल + सीमाएं प्राप्त करता है और stdout/stderr/exit लौटाता है।"}>

```html
<div class="diagram-sandbox">
  <div class="diagram-box" data-rough>
    <strong>पैरेंट प्रोसेस</strong
    ><small class="diagram-muted"
      >module बनाता है · loopback bridge · env scrub · output format</small
    >
  </div>
  ...
  <div class="diagram-panel center" data-rough>
    ...
    ><small class="diagram-muted"
      >स्थानीय child · Docker · remote · durable रनटाइम</small
    >
  </div>
</div>
```
...
<FileTree
  ...
  entries={[
    ...
    {
      path: "../run-code.ts",
      note: "seam को wire करता है; backend बदलने पर कभी नहीं बदलता",
    },
  ]}
/>
