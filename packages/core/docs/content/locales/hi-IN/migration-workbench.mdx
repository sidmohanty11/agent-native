...
<Diagram id="doc-block-1liu37z" title={"/माइग्रेट एक कोड सत्र है, कोई अलग ऐप नहीं"} summary={"एक पथ, URL, या विवरण अंदर जाता है; रन हर दूसरे कोड सत्र के समान स्टोर, ट्रांसक्रिप्ट और नियंत्रण साझा करता है, और एक पोर्टेबल डोजियर उत्सर्जित कर सकता है।"}>
...
<div class="diagram-migrate">
  ...
  <div class="diagram-panel center" data-rough>
    ...
    ><small class="diagram-muted">वही store · transcript · run controls</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-col">
    <div class="diagram-box" data-rough>माइग्रेटेड ऐप</div>
