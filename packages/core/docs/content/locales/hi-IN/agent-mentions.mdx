...
<Diagram id="doc-block-1pcaejd" title={"जहां एक @-उल्लेख मार्ग"} summary={"सर्वर प्रत्येक उल्लेख को प्रकार के आधार पर विभाजित करता है: कस्टम एजेंट स्थानीय रूप से चलते हैं, कनेक्टेड एजेंट A2A पर जाते हैं - दोनों प्रतिक्रियाएँ मुख्य एजेंट के संदर्भ में वापस आ जाती हैं।"}>
...
<div class="diagram-mention">
  ...
  <div class="diagram-panel center" data-rough>
    <span class="diagram-pill accent">सर्वर हल करता है</span
  ...
  <div class="diagram-col">
    <div class="row">
      ...
      <div class="diagram-box">
        कस्टम एजेंट<br /><small class="diagram-muted"
    ...
    <div class="row">
      <span class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</span>
      <div class="diagram-box">
        कनेक्टेड एजेंट<br /><small class="diagram-muted"
...
पूर्ण प्रारूप के लिए [एजेंट संसाधन — Custom Agents](/docs/agent-resources#custom-agents) देखें (`tools`, `delegate-default` और मॉडल ओवरराइड सहित)।
...
<AnnotatedCode
  id="doc-block-1w1w9sc"
  title={"एक कस्टम उल्लेख प्रदाता"}
