...
<Diagram id="doc-block-e1illq" title={"एक स्कीमा, कई बैकएंड"} summary={"ऐप कोड फ्रेमवर्क के बोली-अज्ञेयवादी सहायकों का उपयोग करता है। रनटाइम पर DATABASE_URL से बोली का स्वतः पता लगाया जाता है; अनसेट का अर्थ है स्थानीय SQLite फ़ाइल।"}>
...
<DataModel
  ...
  title={"कार्य तालिका"}
  summary={
    "framework helpers के साथ एक बार परिभाषित; dialect को runtime पर DATABASE_URL से चुना जाता है."
  }
  entities={[
    {
      id: "tasks",
...
<AnnotatedCode
  id="doc-block-3tx7l7"
  title={"एक एडिटिव माइग्रेशन प्लगइन"}
  ...
  annotations={[
    {
      lines: "6-7",
      label: "केवल योगात्मक",
      note: "`ADD COLUMN IF NOT EXISTS` दोबारा चलाने के लिए सुरक्षित है और डेटा कभी नहीं गिरता। नाम बदलना ड्रॉप+क्रिएट से Drizzle जैसा दिखता है, इसलिए इसके बजाय जोड़ें-फिर-माइग्रेट करें।",
    },
    {
      lines: "13-16",
      label: "डायलेक्ट गेटिंग",
    ...
    },
    {
      ...
      note: "प्रत्येक ऐप अपने स्वयं के लागू संस्करणों को ट्रैक करता है इसलिए पुनरारंभ और इंस्टेंसेस में माइग्रेशन अप्रासंगिक होते हैं।",
    },
  ]}
/>
