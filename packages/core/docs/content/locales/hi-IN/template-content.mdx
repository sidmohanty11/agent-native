...
<Diagram id="doc-block-1sn1jmy" title={"दस्तावेज़ एक, संपादक अनेक"} summary={"आप और एजेंट दोनों एक ही Yjs पाइपलाइन के माध्यम से लिखते हैं। SQL विहित स्टोर है; स्थानीय फ़ाइलें और Notion वैकल्पिक सिंक सतहें हैं।"}>
...
<div class="diagram-flow">
  <div class="diagram-col">
    ...
    <div class="diagram-node">
      एजेंट संपादन<br /><small class="diagram-muted"
  ...
  <div class="diagram-panel center">
    ...
    ><small class="diagram-muted">लाइव, conflict-free merge</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  ...
  <div class="diagram-col">
    ...
    <div class="diagram-box">
      Notion पेज<br /><small class="diagram-muted">pull · push</small>
    </div>
  </div>
</div>
```
...
<DataModel
  id="doc-block-18ohlgg"
  title={"सामग्री डेटा मॉडल"}
  summary={
