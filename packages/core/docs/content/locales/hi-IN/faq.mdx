...
<Diagram id="doc-block-1wutpuf" title={"बोल्टेड-ऑन AI बनाम agent-native"} summary={"बोल्ट-ऑन चैट साइडबार अपनी ही दुनिया में रहता है। एक agent-native एजेंट UI के समान क्रियाएँ, डेटाबेस और स्थिति साझा करता है।"}>

```html
<div class="diagram-vs">
  <div class="diagram-col">
    <span class="diagram-pill warn">ऊपर से जोड़ी गई AI</span>
    <div class="diagram-node">चैट साइडबार</div>
    <div class="diagram-arrow diagram-muted" aria-hidden="true">&darr;</div>
    <div class="diagram-box" data-rough>
      अलग AI दुनिया<br /><small class="diagram-muted">ऐप को छू नहीं सकता</small>
    </div>
...
SSE समान-प्रक्रिया ब्राउज़र के लिए एक तत्काल पथ लिखता है, और एक हल्का संस्करण-काउंटर पोल फ़ॉलबैक रहता है क्योंकि यह हर परिनियोजन वातावरण में काम करता है - सर्वर रहित और किनारे सहित, जहां लगातार सॉकेट उपलब्ध नहीं हो सकते हैं। [Key Concepts — लाइव सिंक](/docs/key-concepts#polling-sync) देखें.

<Diagram id="doc-block-1byzv3r" title={"SSE प्रथम, मतदान फ़ॉलबैक"} summary={"समान-प्रक्रिया तुरंत स्ट्रीम लिखती है; एक संस्करण-काउंटर पोल सर्वर रहित, एज और क्रॉस-प्रोसेस लेखन को अभिसरण रखता है।"}>

```html
<div class="diagram-transport">
  <div class="diagram-box" data-rough>DB लेखन</div>
  ...
  <div class="diagram-col">
    ...
    <div class="diagram-node">
      पोल<br /><small class="diagram-muted"
        >/_agent-native/poll &middot; universal fallback</small
      >
    </div>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-box" data-rough>ब्राउज़र फिर से fetch करता है</div>
</div>
```
