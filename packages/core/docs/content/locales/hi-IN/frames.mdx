...
<Diagram id="doc-block-1ipncy0" title={"तीन फ़्रेम, एक रनटाइम"} summary={"आपका ऐप और एजेंट पैनल हर फ्रेम में समान हैं; केवल उनके चारों ओर का आवरण बदलता है।"}>

```html
<div class="diagram-frames">
  <div class="diagram-card" data-rough>
    <span class="diagram-pill accent">एम्बेडेड पैनल</span
    ><small class="diagram-muted">हर ऐप में शामिल · dev + prod</small>
  </div>
  <div class="diagram-card" data-rough>
    <span class="diagram-pill">स्थानीय dev फ्रेम</span
    ><small class="diagram-muted">iframe में ऐप + पैनल + CLI टर्मिनल</small>
  </div>
  <div class="diagram-card" data-rough>
    <span class="diagram-pill">Builder.io क्लाउड फ्रेम</span
    ><small class="diagram-muted"
      >होस्टेड: सहयोग · दृश्य संपादन · समानांतर रन</small
    >
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&darr;</div>
  <div class="diagram-box" data-rough>
    वही runtime<br /><small class="diagram-muted"
      >आपका ऐप · actions · application state</small
    >
  </div>
</div>
```
...
- पूर्ण चैट / CLI / एजेंट संसाधन सतह प्रदान करता है, ताकि एजेंट इनपुट चालू रहे
...
<Diagram id="doc-block-k2k7s3" title={"कोड-अनुरोध गेटिंग"} summary={"कोड-टाइप किए गए संदेश को कोड-सक्षम फ़्रेम की आवश्यकता होती है। एक कनेक्टेड के साथ, अनुरोध मार्ग वहां; बिना किसी के, पैनल बताता है कि कोड परिवर्तन के लिए Desktop या Builder की आवश्यकता होती है।"}>
...
[Builder.io](https://www.builder.io?utm_source=agent-native&utm_medium=docs&utm_campaign=framework&utm_content=frames) एक प्रबंधित फ़्रेम प्रदान करता है जो
