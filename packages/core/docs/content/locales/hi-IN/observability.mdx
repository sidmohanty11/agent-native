...
<Diagram id="doc-block-w0wj2q" title={"प्रत्येक रन लूप को फीड करता है"} summary={"एक एजेंट रन एक ट्रेस, स्वचालित स्कोर और एक फीडबैक हुक उत्पन्न करता है - सभी ऐप के अपने SQL में संग्रहीत होते हैं और डैशबोर्ड पर सामने आते हैं। प्रयोगों ने ट्रैफ़िक को कॉन्फ़िग वेरिएंट में विभाजित कर दिया।"}>

```html
<div class="obs-loop">
  <div class="diagram-node">
    एजेंट रन<br /><small class="diagram-muted">production-agent.ts</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-panel center">
    <span class="diagram-pill accent">स्वचालित रूप से कैप्चर</span
...
<Diagram id="doc-block-102vtgy" title={"सुसंगत-हैश वैरिएंट असाइनमेंट"} summary={"प्रत्येक उपयोगकर्ता एक स्थिर वैरिएंट के लिए हैश करता है, लूप उस वैरिएंट की कॉन्फ़िगरेशन ओवरराइड को लागू करता है, और परिणाम विश्वास अंतराल के साथ प्रति वैरिएंट रोल अप करते हैं।"}>

```html
<div class="exp">
  <div class="diagram-node">
    यूजर ID<br /><small class="diagram-muted">consistent hash</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-col">
    <div class="diagram-card">
      <span class="diagram-pill">control &middot; 50%</span
      ><small class="diagram-muted">कॉन्फिग override A</small>
    </div>
    <div class="diagram-card">
      <span class="diagram-pill accent">treatment &middot; 50%</span
      ><small class="diagram-muted">कॉन्फिग override B</small>
    </div>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-box">
    परिणाम per variant<br /><small class="diagram-muted"
