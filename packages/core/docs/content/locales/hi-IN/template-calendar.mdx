...
<Diagram id="doc-block-vp4fny" title={"शेड्यूलिंग अनुरोध कैसे प्रवाहित होता है"} summary={"चाहे आप कैलेंडर में क्लिक करें या एजेंट से पूछें, वही क्रियाएं Google Calendar से लाइव पढ़ेंगी और उसी दृश्य पर वापस लिखेंगी।"}>
...
<div class="diagram-flow">
  ...
  <div class="diagram-col">
    ...
    <div class="diagram-box">
      SQL<br /><small class="diagram-muted">बुकिंग · उपलब्धता</small>
    </div>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&#8635;</div>
  <div class="diagram-box">Calendar view लाइव अपडेट होती है</div>
</div>
```
...
<DataModel
  id="doc-block-12vlmo"
  title={"Calendar डेटा मॉडल"}
  summary={
    "केवल गैर-इवेंट डेटा स्थानीय रूप से संग्रहीत किया जाता है - इवेंट Google Calendar में रहते हैं। बुकिंग लिंक स्वामित्व योग्य कॉलम का उपयोग करते हैं इसलिए साझाकरण प्रणाली लागू होती है।"
  }
  entities={[
    {
      id: "booking_links",
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          name: "status",
          type: "enum",
          note: "पुष्टि की गई | रद्द कर दिया गया",
        },
      ],
    },
    {
