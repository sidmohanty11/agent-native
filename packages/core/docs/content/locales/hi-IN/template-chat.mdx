...
<Diagram id="doc-block-19jodct" title={"चैट शेल में क्या जहाज़ हैं"} summary={"फ्रेमवर्क के मानक रनटाइम पर एक पतली चैट सतह - क्रियाएं, टिकाऊ थ्रेड, लाइव सिंक और ऑथ - जिसमें अपना यूआई जोड़ने के लिए जगह है।"}>
...
<div class="diagram-chat">
  <div class="diagram-col left">
    <div class="diagram-node">
      थ्रेड सूची<br /><small class="diagram-muted"
        >बनाएँ · फिर खोलें · पिन करें · आर्काइव करें</small
      >
    </div>
    <div class="diagram-node">
      पूर्ण-पृष्ठ चैट<br /><small class="diagram-muted"
        >/ पर framework chat surface</small
      >
    </div>
  </div>
  ...
  <div class="diagram-col right">
    <div class="diagram-box">
      मुख्य SQL तालिकाएँ<br /><small class="diagram-muted"
        >threads · application_state · settings · sessions · runs</small
      >
    </div>
    <div class="diagram-pill ok">लाइव सिंक &#8635;</div>
    <div class="diagram-box">
      Better Auth<br /><small class="diagram-muted">लॉगिन · संगठन · सेशन</small>
    </div>
  </div>
</div>
```
