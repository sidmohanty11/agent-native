...
<Diagram id="doc-block-isxt5n" title={"तीन तरह से, एक सत्र"} summary={"ब्राउज़र विज़िटर, प्रोग्रामेटिक MCP क्लाइंट और कस्टम प्रदाता सभी उसी AuthSession को हल करते हैं जिसे डाउनस्ट्रीम स्कोपिंग पढ़ता है।"}>
