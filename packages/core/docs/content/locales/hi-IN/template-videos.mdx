...
<WireframeBlock id="doc-block-es9mw0">
  <Screen
    surface="desktop"
    html={
...
<Diagram id="doc-block-1uqarqo" title={"डेटा के रूप में एनीमेशन"} summary={"एक रचना एक React घटक है; प्रत्येक एनीमेशन एक ट्रैक से पढ़ता है इसलिए एजेंट और टाइमलाइन उसी डेटा को संपादित करते हैं।"}>
...
<div class="diagram-flow">
  <div class="diagram-col">
    <div class="diagram-node">
      Timeline<br /><small class="diagram-muted"
        >खींचें, आकार बदलें, स्क्रब करें</small
      >
    </div>
    <div class="diagram-node">
  ...
  <div class="diagram-box" data-rough>
    React कंपोजिशन<br /><small class="diagram-muted"
...
<DataModel
  id="doc-block-grug1j"
  title={"वीडियो डेटा मॉडल"}
  summary={
    "SQL-समर्थित रचनाएँ प्लस डिज़ाइन सिस्टम और नेस्टेबल फ़ोल्डर्स, प्रत्येक एक फ्रेमवर्क शेयर तालिका के साथ।"
  }
  entities={[
    {
      id: "compositions",
