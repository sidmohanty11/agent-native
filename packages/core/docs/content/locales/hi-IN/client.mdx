...
<Diagram id="doc-block-f248eh" title={"ब्राउज़र डेटा लूप"} summary={"हुक क्रियाओं के माध्यम से पढ़ते और लिखते हैं; useDbSync डेटाबेस पर नज़र रखता है इसलिए एजेंट और बैकग्राउंड स्वचालित रूप से समान कैश पुनः प्राप्त करते हैं।"}>
...
<div class="diagram-client">
  ...
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&harr;</div>
  <div class="diagram-panel" data-rough><strong>SQL डेटाबेस</strong></div>
...
<Diagram id="doc-block-1o7phrk" title={"रीफ़ेच के लिए दो रास्ते"} summary={"एक स्थानीय उत्परिवर्तन अपने स्वयं के कैश को तुरंत अमान्य कर देता है; एक दूरस्थ लेखन इस टैब पर SSE, या फ़ॉलबैक के रूप में पोलिंग टिक तक पहुंचता है।"}>
...
<div class="diagram-latency">
  <div class="diagram-col">
    ...
    <div class="diagram-card" data-rough>
      <span class="diagram-pill accent">एजेंट · webhook · दूसरा टैब</span
      ><strong>रिमोट लेखन</strong
      ><small class="diagram-muted"
