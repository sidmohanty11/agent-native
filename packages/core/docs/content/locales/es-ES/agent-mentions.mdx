...
<Diagram id="doc-block-7yvj8t" title={"Donde se dirige una mención @"} summary={"El servidor divide cada mención por tipo: los agentes personalizados se ejecutan localmente, los agentes conectados pasan por A2A; ambas respuestas se pliegan al contexto del agente principal."}>
...
<div class="diagram-mention">
  ...
  <div class="diagram-panel center" data-rough>
    <span class="diagram-pill accent">El servidor resuelve</span
  ...
  <div class="diagram-col">
    <div class="row">
      ...
      <div class="diagram-box">
        Agente personalizado<br /><small class="diagram-muted"
    ...
    <div class="row">
      <span class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</span>
      <div class="diagram-box">
        Agente conectado<br /><small class="diagram-muted"
...
Consulte [Recursos del Agente — Custom Agents](/docs/agent-resources#custom-agents) para conocer el formato completo (incluidos `tools`, `delegate-default` y anulaciones de modelos).
...
<AnnotatedCode
  id="doc-block-4dp7w2"
  title="Un proveedor de menciones personalizado"
