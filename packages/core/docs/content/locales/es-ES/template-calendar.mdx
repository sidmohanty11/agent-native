...
<WireframeBlock id="doc-block-1c8k6ed">
  <Screen
    surface="desktop"
    html={
...
<Diagram id="doc-block-1t91co3" title={"Cómo fluye una solicitud de programación"} summary={"Ya sea que haga clic en el calendario o le pregunte al agente, las mismas acciones se leen en vivo desde Google Calendar y se escriben nuevamente en la misma vista."}>

```html
<div class="diagram-flow">
  <div class="diagram-col">
    <div class="diagram-node">
      Tú haces clic<br /><small class="diagram-muted"
...
<DataModel
  id="doc-block-yzvg49"
  title="Modelo de datos de Calendar"
  summary={
    "Solo los datos que no son eventos se almacenan localmente: los eventos viven en Google Calendar. Los enlaces de reserva utilizan ownableColumns, por lo que se aplica el sistema para compartir."
  }
  entities={[
    {
      id: "booking_links",
