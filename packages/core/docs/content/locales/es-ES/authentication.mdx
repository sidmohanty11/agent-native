...
<Diagram id="doc-block-1lj059p" title={"Tres entradas, una sesión"} summary={"Los visitantes del navegador, los clientes programáticos MCP y los proveedores personalizados se resuelven en la misma sesión de autenticación que lee el alcance descendente."}>
