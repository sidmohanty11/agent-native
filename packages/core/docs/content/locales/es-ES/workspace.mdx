...
<Diagram id="doc-block-1v2thml" title="Un espacio de trabajo Claude-Code, pero almacenado en SQL" summary={"La misma capa de personalización (instrucciones, habilidades, memoria, agentes, trabajos, MCP) excepto que cada archivo es una fila en una base de datos compartida de múltiples inquilinos."}>
...
<div class="ws-map">
  ...
  <div class="diagram-card an">
    <span class="diagram-pill accent">Workspace agent-native</span
    ><small class="diagram-muted">rows in one base de datos SQL</small>
    <div class="ws-rows">
...
<DataModel
  ...
  title="El modelo de recursos del espacio de trabajo"
  summary={
    "Una forma de recurso respalda cada archivo de espacio de trabajo. El tiempo de ejecución lo clave por ruta y alcance y resuelve el valor efectivo en la lectura."
  }
  entities={[
    {
      id: "resource",
