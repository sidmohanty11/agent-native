...
<Diagram id="doc-block-qeqnep" title={"/migrate es una sesión de Código, no una aplicación separada"} summary={"Entra una ruta, URL, o descripción; la ejecución comparte el mismo almacén, transcripción y controles que cualquier otra sesión de Código y puede emitir un expediente portátil."}>
...
<div class="diagram-migrate">
  ...
  <div class="diagram-panel center" data-rough>
    ...
    ><small class="diagram-muted"
      >mismo almacén · transcripción · controles de ejecución</small
    >
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-col">
    <div class="diagram-box" data-rough>App migrada</div>
