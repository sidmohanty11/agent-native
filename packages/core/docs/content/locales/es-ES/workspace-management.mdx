...
Para conocer el modelo de recursos y las rutas canónicas, consulte [Recursos del Agente — Recursos globales](/docs/workspace#global-resources).
...
- [ ] Registre conexiones de espacio de trabajo reutilizables para cuentas de proveedores compartidos y luego
      ...
      esa cuenta
- [ ] Agregue skills para todo el espacio de trabajo, instrucciones de barandilla y recursos de referencia de marca/empresa a través de la página Recursos. Consulte [Recursos del Agente](/docs/workspace#global-resources) para ver la tabla completa de modelos de recursos y el paquete de inicio recomendado.
