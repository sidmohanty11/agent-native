...
<Diagram id="doc-block-1i4grvb" title="Tres rutas, un paquete" summary={"El complemento universal CLI, Claude Code y Codex instalan las mismas dos habilidades más el conector del plan alojado."}>
