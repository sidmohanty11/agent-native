...
<Diagram id="doc-block-182gis3" title="IA integrada frente a agent-native" summary={"Una barra lateral de chat integrada vive en su propio mundo. Un agente agent-native comparte las mismas acciones, base de datos y estado que la interfaz de usuario."}>

```html
<div class="diagram-vs">
  <div class="diagram-col">
    <span class="diagram-pill warn">IA añadida por encima</span>
    <div class="diagram-node">Barra lateral de chat</div>
    <div class="diagram-arrow diagram-muted" aria-hidden="true">&darr;</div>
    <div class="diagram-box" data-rough>
      mundo de IA separado<br /><small class="diagram-muted"
        >no puede tocar la app</small
      >
    </div>
...
<Diagram id="doc-block-bph01y" title="SSE primero, respaldo de encuesta" summary={"Las escrituras en el mismo proceso se transmiten al instante; una encuesta de contador de versiones mantiene convergentes las escrituras sin servidor, perimetrales y entre procesos."}>

```html
<div class="diagram-transport">
  <div class="diagram-box" data-rough>Escritura en BD</div>
  ...
  <div class="diagram-col">
    ...
    <div class="diagram-node">
      Sondeo<br /><small class="diagram-muted"
        >/_agent-native/poll &middot; universal fallback</small
      >
    </div>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-box" data-rough>Recarga del navegador</div>
</div>
```
