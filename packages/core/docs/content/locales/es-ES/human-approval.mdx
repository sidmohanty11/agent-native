...
<AnnotatedCode
  id="doc-block-15w96g5"
  title={"Cerrar la única acción consecuente"}
  ...
  annotations={[
    {
      lines: "10",
      label: "toda la puerta",
      note: "Una bandera. Si es veraz y la llamada no está aprobada, el ciclo se detiene antes de `run`: el modelo nunca alcanza el efecto secundario por sí solo.",
    },
    {
      lines: "11-13",
      label: "run() is untouched",
      note: "El manejador sigue siendo el mismo. La aprobación la impone el bucle que lo rodea, no nada dentro de `run`.",
    },
  ]}
/>
...
<Diagram id="doc-block-q1vb4z" title={"La interrupción de la aprobación"} summary={"Una llamada cerrada pausa el turno antes de que se active run(). La aprobación reemite el turno llevando la clave de la convocatoria; sólo entonces ocurre el efecto secundario."}>
...
<div class="diagram-approve">
  ...
  <div class="diagram-panel warn" data-rough>
    <strong>Gate verdadero, llamada aún no aprobada</strong
  ...
  <div class="diagram-box" data-rough>
    La persona hace clic en Aprobar en el chat<br /><small class="diagram-muted"
