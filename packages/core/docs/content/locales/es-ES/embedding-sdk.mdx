...
<Diagram id="doc-block-nshhbq" title={"La membrana de inclusión"} summary={"La aplicación host proporciona autenticación del lado del servidor y contexto de página en vivo; Agent-Native ejecuta el sidecar duradero y llega a la pestaña abierta mediante acciones del cliente y comandos del host."}>

```html
<div class="diagram-embed">
  <div class="diagram-box" data-rough>
    <strong>App SaaS anfitriona</strong
    ><small class="diagram-muted">tu interfaz, tu autenticación</small>
  </div>
  <div class="diagram-col">
    <div class="diagram-pill accent">getContext &rarr;</div>
    <div class="diagram-pill">&larr; acciones de cliente</div>
    <div class="diagram-pill">&larr; comandos del host</div>
  </div>
  <div class="diagram-panel center" data-rough>
    <strong>Agent-Native sidecar</strong
    ><small class="diagram-muted"
      >chat durable · estado de app · extensiones</small
    >
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-box" data-rough>
    SQL<br /><small class="diagram-muted">tablas del framework</small>
  </div>
</div>
```
...
<Diagram id="doc-block-187h0pb" title={"Puente de sesión de navegador mediado por servidor"} summary={"Una herramienta de backend pone en cola el trabajo; la pestaña registrada lo reclama, lo ejecuta en la página activa y el resultado regresa al agente, por lo que un agente backend/Slack/A2A aún puede tocar la pestaña abierta."}>

```html
<div class="diagram-bridge">
  <div class="diagram-node" data-rough>
    Agente backend<br /><small class="diagram-muted"
      >charla · Slack · A2A</small
    >
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-box" data-rough>
  ...
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-node" data-rough>
    La pestaña activa lo reclama<br /><small class="diagram-muted"
