...
<FileTree
  id="doc-block-1525m3a"
  title={"Un agente Agent-Native básico"}
  entries={[
    {
      path: "AGENTS.md",
...
<Diagram id="doc-block-xk8dna" title={"Una acción, cada superficie"} summary={"Un único archivo defineAction se distribuye a cada consumidor sin cableado adicional."}>
...
<div class="diagram-fan">
  ...
  <div class="diagram-surfaces">
    <span class="diagram-pill">Interfaz de chat</span
