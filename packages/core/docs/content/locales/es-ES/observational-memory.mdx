...
<Diagram id="doc-block-ms60t5" title="Tres niveles, destilados a lo reciente" summary={"El prefijo más antiguo se convierte en observaciones fechadas y una reflexión de arco largo; sólo los giros más recientes permanecen textuales."}>

```html
<div class="om">
  <div class="diagram-card">
    <span class="diagram-pill">Reflexiones</span
    ><small class="diagram-muted"
      >resumen de largo plazo condensado del registro de observaciones</small
    >
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&uarr;</div>
  <div class="diagram-card">
    <span class="diagram-pill accent">Observaciones</span
    ><small class="diagram-muted"
      >entradas densas con fecha que agrupan tramos de mensajes sin
      procesar</small
    >
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&uarr;</div>
  <div class="diagram-card">
    <span class="diagram-pill ok">Mensajes recientes sin procesar</span
    ><small class="diagram-muted"
      >last N turns, kept <strong>verbatim</strong> — nunca plegados</small
    >
  </div>
</div>
```
...
<Diagram id="doc-block-wwjpz4" title={"Dos pases de mejor esfuerzo después de un giro limpio"} summary={"Cada uno pasa sin operaciones por debajo de su umbral, por lo que hacer funcionar el compactador en cada turno es económico. Los fallos se absorben y nunca añaden latencia."}>

```html
<div class="om-pass">
  <div class="diagram-node">
    Termina un turno limpio<br /><small class="diagram-muted"
      >fire-and-forget</small
    >
  </div>
