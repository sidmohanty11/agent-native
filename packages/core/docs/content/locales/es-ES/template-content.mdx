...
<Diagram id="doc-block-ffng01" title="Un documento, muchos editores" summary={"Tanto usted como el agente escriben a través del mismo canal Yjs. SQL es la tienda canónica; Los archivos locales y Notion son superficies de sincronización opcionales."}>
...
<div class="diagram-flow">
  ...
  <div class="diagram-panel center">
    ...
    ><small class="diagram-muted">en vivo, fusión sin conflictos</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
...
<DataModel
  id="doc-block-1p1oj2y"
  title="Modelo de datos Content"
  summary={
    "Nueve tablas en server/db/schema.ts. documents es el árbol de páginas; las demás cuelgan de él para versiones, comentarios, sincronización con Notion, bases de datos inline y uso compartido."
  }
  entities={[
    {
      id: "documents",
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          type: "string",
          nullable: true,
          note: "sincronización bidireccional de Notion",
        },
      ],
    },
    {
