...
<WireframeBlock id="doc-block-pp45du">
  <Screen
    surface="desktop"
    html={
...
<Diagram id="doc-block-mnaf3f" title="Construir, publicar, recopilar" summary={"El agente y el editor visual editan una definición de formulario SQL-backed. La página de llenado pública no está autenticada y los envíos se dirigen del lado del servidor a sus destinos."}>

```html
<div class="diagram-flow">
  <div class="diagram-col">
    <div class="diagram-node">
      Prompt del agente<br /><small class="diagram-muted"
...
<DataModel
  id="doc-block-ljpo3c"
  title="Modelo de datos de Forms"
  summary={
    "Tres mesas. Los campos y las integraciones son columnas JSON en los formularios, por lo que las ediciones del agente son parches quirúrgicos en lugar de cambios de filas entre tablas."
  }
  entities={[
    {
      id: "forms",
      ...
      fields: [
        ...
        },
        {
          name: "fields",
          type: "json",
          note: "FormField[]: todos los tipos de campos",
        },
        {
          name: "settings",
          type: "json",
          note: "FormSettings: integraciones, etc.",
        },
        {
          name: "status",
          type: "enum",
          note: "borrador | publicado | cerrado",
        },
        {
          name: "deleted_at",
          type: "datetime",
