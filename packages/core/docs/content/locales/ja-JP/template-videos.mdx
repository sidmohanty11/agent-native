...
<Diagram id="doc-block-vmds50" title={"データとしてのアニメーション"} summary={"コンポジションは React コンポーネントです。すべてのアニメーションはトラックから読み込まれるため、エージェントとタイムラインは同じデータを編集します。"}>
...
<div class="diagram-flow">
  ...
  <div class="diagram-box" data-rough>
    Reactコンポジション<br /><small class="diagram-muted"
...
<DataModel
  id="doc-block-1508siv"
  title={"ビデオデータモデル"}
  summary={
    "SQL でサポートされたコンポジションに加え、デザイン システムとネスト可能なフォルダーがあり、それぞれにフレームワーク共有テーブルが含まれます。"
  }
  entities={[
    {
      id: "compositions",
