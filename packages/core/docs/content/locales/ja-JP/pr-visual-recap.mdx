...
{
  "html": "<div class=\"diagram-recap\"><div class=\"diagram-node\">PR プッシュ<br><small class=\"diagram-muted\">bounded base&hellip;head diff</small></div><div class=\"diagram-arrow diagram-muted\" aria-hidden=\"true\">&rarr;</div><div class=\"diagram-node\">コーディングエージェント<br><small class=\"diagram-muted\">Claude Code / Codex が diff を読む</small></div><div class=\"diagram-arrow diagram-muted\" aria-hidden=\"true\">&rarr;</div><div class=\"diagram-panel center\"><span class=\"diagram-pill accent\">create-visual-recap</span><small class=\"diagram-muted\">publishes recap plan</small></div><div class=\"diagram-arrow diagram-muted\" aria-hidden=\"true\">&rarr;</div><div class=\"diagram-node\">ヘッドレス Chrome<br><small class=\"diagram-muted\">light + dark screenshots</small></div><div class=\"diagram-arrow diagram-muted\" aria-hidden=\"true\">&rarr;</div><div class=\"diagram-box\">固定 PR コメント 1 件<br><small class=\"diagram-muted\">inline screenshot + plan link</small></div></div><div class=\"diagram-foot diagram-muted\">Plus an informational <span class=\"diagram-pill\">Visual Recap</span> check &mdash; non-blocking, never required.</div>",
...
{
  "html": "<div class=\"diagram-fork\"><div class=\"diagram-node\">Fork PR が開かれました<br><small class=\"diagram-muted\">main workflow has no secrets</small></div><div class=\"diagram-arrow diagram-muted\" aria-hidden=\"true\">&rarr;</div><div class=\"diagram-card\"><span class=\"diagram-pill ok\">信頼済み作者</span><small class=\"diagram-muted\">OWNER、MEMBER、COLLABORATOR は自動実行</small></div><div class=\"diagram-card\"><span class=\"diagram-pill warn\">外部コントリビューター</span><small class=\"diagram-muted\">メンテナーが diff を確認してから適用 <code>recap</code></small></div><div class=\"diagram-arrow diagram-muted\" aria-hidden=\"true\">&rarr;</div><div class=\"diagram-panel center\">ゲートチェック<br><small class=\"diagram-muted\">fork PR? &amp; trusted or fresh label?</small></div><div class=\"diagram-arrow diagram-muted\" aria-hidden=\"true\">&rarr;</div><div class=\"diagram-box ok\">要約実行<br><small class=\"diagram-muted\">base repo のコードのみ · fork diff はテキスト入力</small></div></div>",
