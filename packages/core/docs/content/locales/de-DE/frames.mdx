...
- Stellt die vollständige Chat-/CLI-/Agent-Ressourcen-Oberfläche bereit, sodass die Agenteneingabe aktiviert bleibt
...
<Diagram id="doc-block-he07jv" title="Code-Anfrage-Gating" summary={"Eine codetypisierte Nachricht benötigt einen codefähigen Rahmen. Wenn einer verbunden ist, wird die Anfrage dorthin weitergeleitet. Ohne eins erklärt das Panel, dass Codeänderungen Desktop oder Builder erfordern."}>
...
[Builder.io](https://www.builder.io?utm_source=agent-native&utm_medium=docs&utm_campaign=framework&utm_content=frames) stellt einen verwalteten Frame bereit, der das hostet
