...
<Diagram id="doc-block-zzy087" title="Drei Routen, ein Paket" summary="Die universellen Plugins CLI, Claude Code und Codex installieren alle dieselben zwei Skills sowie den gehosteten Plan-Connector.">
