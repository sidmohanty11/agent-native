...
- Eine gewöhnliche spätere Antwort im selben Thread erreicht den Agenten **nur, solange dieser Thread noch laufende Arbeit hat**. Ist der Lauf beendet, wird Ihre Nachfrage ignoriert — erwähnen Sie den Agenten erneut, statt anzunehmen, dass er weiter zuhört.
...
| Es hat einmal funktioniert, eine spätere Antwort im Thread wurde ignoriert | Das ist erwartet. Thread-Antworten ohne Erwähnung erreichen den Agenten nur, solange der Thread aktive Arbeit hat — erwähnen Sie ihn erneut.                                             |
