...
<Diagram id="doc-block-1qzab5j" title={"Einmal verbinden, Apps gewähren, Anmeldeinformationen wiederverwenden"} summary={"Eine Verbindung enthält Anbietermetadaten (niemals Geheimnisse) und CredentialRefs, die auf den Tresor verweisen. Per App-Zuschüsse wird es freigeschaltet. Apps lesen einen einzelnen Bereitschaftsstatus."}>
  ...
  <div class="diagram-panel col" data-rough>
    ...
    <div class="diagram-box" data-rough>
      named provider account<br /><small class="diagram-muted"
        >provider, label, Status, Scopes, Konfiguration &middot; never stores
        secret values</small
      >
    </div>
...
<DataModel
  id="doc-block-1e6o7vt"
  title="Das Verbindungsmodell"
  summary={
  ...
  entities={[
    {
      ...
      fields: [
        ...
        },
        {
          name: "provider",
          type: "string",
          note: "stabile Anbieter-ID, z.B. locker",
        },
        {
          name: "label",
          type: "string",
        ...
        },
        {
          ...
          type: "json",
          nullable: true,
          note: "sichere, nicht geheime Konfiguration",
        },
        {
          name: "credentialRefs",
          type: "json",
...
<Diagram id="doc-block-185a7ue" title="Verbindungsspeicher vs. Tresor" summary={"Der Tresor ist Eigentümer des geheimen Werts. Die Verbindung besitzt Provider-Metadaten sowie CredentialRefs (Zeiger). Zur Ausführungszeit löst die App den Verweis über eine gewährte Verbindung auf und liest den Wert aus dem Tresor."}>

```html
<div class="diagram-vault">
  <div class="diagram-panel col" data-rough>
    <span class="diagram-pill accent">Verbindungsspeicher</span>
    <div class="diagram-box" data-rough>
      provider account + metadata<br /><small class="diagram-muted"
        >Status, Scopes, Konfiguration</small
      >
    </div>
    <div class="diagram-box" data-rough>
  ...
  <div class="diagram-panel col" data-rough>
    ...
    <div class="diagram-box" data-rough>
      secret value<br /><small class="diagram-muted"
        >nie an Agent oder UI zurückgegeben</small
      >
    </div>
  </div>
</div>
