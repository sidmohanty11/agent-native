...
<Diagram id="doc-block-1hpxy2j" title="Drei Wege rein, eine Sitzung" summary={"Browserbesucher, programmatische MCP-Clients und benutzerdefinierte Anbieter werden alle in dieselbe AuthSession aufgelöst, die das Downstream-Scoping liest."}>
