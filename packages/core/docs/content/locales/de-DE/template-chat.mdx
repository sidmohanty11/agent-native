...
- [**Ihre erste Funktion in Chat**](/docs/template-chat-first-edits) — die Chat-Startroute, kommentiert, sowie eine vollständige Anleitung zum Hinzufügen einer echten Funktion
