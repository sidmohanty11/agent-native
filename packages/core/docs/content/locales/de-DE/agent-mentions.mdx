...
<Diagram id="doc-block-y21kja" title={"Wohin eine @-Erwähnung führt"} summary={"Der Server unterteilt jede Erwähnung nach Typ: Benutzerdefinierte Agenten werden lokal ausgeführt, verbundene Agenten gehen über A2A – beide Antworten werden in den Kontext des Hauptagenten zurückgeführt."}>
...
<div class="diagram-mention">
  ...
  <div class="diagram-panel center" data-rough>
    <span class="diagram-pill accent">Server löst auf</span
  ...
  <div class="diagram-col">
    <div class="row">
      ...
      <div class="diagram-box">
        Benutzerdefinierter Agent<br /><small class="diagram-muted"
    ...
    <div class="row">
      <span class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</span>
      <div class="diagram-box">
        Verbundener Agent<br /><small class="diagram-muted"
...
Das vollständige Format finden Sie unter [Agent-Ressourcen — Custom Agents](/docs/agent-resources#custom-agents) (einschließlich `tools`, `delegate-default` und Modellüberschreibungen).
...
<AnnotatedCode
  id="doc-block-19gdfwg"
  title="Ein benutzerdefinierter MentionProvider"
