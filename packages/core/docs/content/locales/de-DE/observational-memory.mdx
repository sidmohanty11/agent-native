...
<Diagram id="doc-block-6g5ff8" title="Dreistufig, destilliert bis aktuell" summary={"Das ältere Präfix gliedert sich in datierte Beobachtungen und eine Langbogenreflexion; nur die letzten Wendungen bleiben wörtlich."}>

```html
<div class="om">
  <div class="diagram-card">
    <span class="diagram-pill">Reflexionen</span
    ><small class="diagram-muted"
      >Langfristige Zusammenfassung aus dem Beobachtungsprotokoll</small
    >
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&uarr;</div>
  <div class="diagram-card">
    <span class="diagram-pill accent">Beobachtungen</span
    ><small class="diagram-muted"
      >dichte, datierte Einträge, die Rohmeldungen zusammenfassen</small
    >
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&uarr;</div>
  <div class="diagram-card">
    <span class="diagram-pill ok">Aktuelle Rohmeldungen</span
    ><small class="diagram-muted"
      >last N turns, kept <strong>verbatim</strong> — nie
      zusammengefaltet</small
    >
  </div>
</div>
```
...
<Diagram id="doc-block-1ug0x0j" title={"Zwei beste Pässe nach einer sauberen Drehung"} summary={"Unterhalb der Schwelle erfolgt bei jedem Durchgang ein No-Ops-Vorgang, daher ist es günstig, den Verdichter in jeder Runde laufen zu lassen. Fehler werden verschluckt und verursachen keine zusätzliche Latenz."}>

```html
<div class="om-pass">
  <div class="diagram-node">
    Sauberer Turn endet<br /><small class="diagram-muted"
