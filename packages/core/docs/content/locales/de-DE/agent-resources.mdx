...
<Diagram id="doc-block-7j8xqp" title="Ein Claude-Code-Setup, aber als Agent-Ressourcen in SQL gespeichert" summary={"Dieselbe Anpassungsebene – Anweisungen, Fähigkeiten, Speicher, Agenten, Jobs, MCP – außer dass jede Datei eine Zeile in einer gemeinsam genutzten, mandantenfähigen Datenbank ist."}>
