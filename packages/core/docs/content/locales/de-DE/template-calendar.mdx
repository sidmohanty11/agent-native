...
<WireframeBlock id="doc-block-j8s8jp">
  <Screen
    surface="desktop"
    html={
...
<Diagram id="doc-block-12pr3gz" title={"Wie eine Planungsanfrage abläuft"} summary={"Unabhängig davon, ob Sie in den Kalender klicken oder den Agenten fragen, werden dieselben Aktionen live aus Google Calendar gelesen und in dieselbe Ansicht zurückgeschrieben."}>

```html
<div class="diagram-flow">
  <div class="diagram-col">
    <div class="diagram-node">
      Du klickst<br /><small class="diagram-muted"
        >Ziehen, Toolbar, Kurzbefehle</small
      >
    </div>
    <div class="diagram-node">
...
<DataModel
  id="doc-block-1sttqod"
  title="Calendar Datenmodell"
  summary={
    "Nur Nicht-Ereignisdaten werden lokal gespeichert – Ereignisse leben in Google Calendar. Buchungslinks verwenden ownableColumns, daher gilt das Freigabesystem."
  }
  entities={[
    {
      id: "booking_links",
