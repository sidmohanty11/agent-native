...
<Diagram id="doc-block-11pjycp" title={"Das pfadlose Layout umschließt die Seiten"} summary={"Ein _app.tsx-Layout (kein URL-Segment) rendert die gemeinsam genutzte Shell einmal; übereinstimmende Seiten werden in ihrem <Outlet/> gerendert, sodass die Agent-Seitenleiste bei der Navigation nie wieder angezeigt wird."}>
...
<div class="diagram-layout" data-rough>
  <div class="diagram-shell">
    ...
    ><small class="diagram-muted"
      >pfadloses Layout · persistente Shell + Agent-Seitenleiste</small
    >
