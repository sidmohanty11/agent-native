...
<Diagram id="doc-block-g1pprw" title="/migrate ist eine Code-Sitzung, keine separate App" summary={"Ein Pfad, URL oder eine Beschreibung wird eingegeben; Die Ausführung nutzt den gleichen Speicher, das gleiche Transkript und die gleichen Steuerelemente wie jede andere Code-Sitzung und kann ein tragbares Dossier ausgeben."}>
...
<div class="diagram-migrate">
  ...
  <div class="diagram-panel center" data-rough>
    ...
    ><small class="diagram-muted"
      >gleicher Store · Transkript · Laufsteuerung</small
    >
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-col">
    <div class="diagram-box" data-rough>Migrierte App</div>
