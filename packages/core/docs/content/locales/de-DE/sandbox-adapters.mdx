...
<Diagram id="doc-block-kt6ebi" title={"Der Elternteil behält die Geheimnisse; Der Adapter führt nur Code aus"} summary={"run-code erstellt das Modul und führt die Loopback-Brücke aus; Der Adapter empfängt ein nicht geheimes Modul + Limits und gibt stdout/stderr/exit zurück."}>

```html
<div class="diagram-sandbox">
  <div class="diagram-box" data-rough>
    <strong>Elternprozess</strong
    ><small class="diagram-muted"
      >baut Modul · Loopback-Bridge · Env-Bereinigung · Ausgabeformat</small
    >
  </div>
  ...
  <div class="diagram-panel center" data-rough>
    ...
    ><small class="diagram-muted"
      >lokaler Child-Prozess · Docker · remote · dauerhaft</small
    >
  </div>
</div>
```
...
<FileTree
  id="doc-block-vd1j1k"
  title="Die Sandbox-Nahtstelle in core"
