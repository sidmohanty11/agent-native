...
Informationen zum Ressourcenmodell und zu den kanonischen Pfaden finden Sie unter [Agent-Ressourcen — Global resources](/docs/workspace#global-resources).
...
- [ ] Dann registrieren Sie wiederverwendbare Workspace-Verbindungen für freigegebene Anbieterkonten
      ...
      dieses Konto
- [ ] Fügen Sie über die Seite „Ressourcen“ arbeitsbereichsweite skills-, Leitplanken-Anweisungen und Marken-/Firmenreferenzressourcen hinzu. Die vollständige Ressourcenmodelltabelle und das empfohlene Starterpaket finden Sie unter [Agent-Ressourcen](/docs/workspace#global-resources).
