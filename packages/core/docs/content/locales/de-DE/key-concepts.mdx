  ...
  <div class="diagram-row">
    <div class="diagram-card">
      ...
      ><small class="diagram-muted"
        >liest und schreibt Daten, führt Actions aus, ändert Code</small
      >
    </div>
    <div class="diagram-card">
...
(`databaseTools: "read"`). Agenten prüfen App-Daten mit `db-schema` /
`db-query` und schreiben über typisierte App-Actions. Setze
`databaseTools: "write"` (oder `true`) nur für bewusste Wartungsflächen, die
auch scoped `db-exec` / `db-patch` anbieten sollen; `databaseTools: "off"` /
