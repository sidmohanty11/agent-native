...
<AnnotatedCode
  id="doc-block-1mwix0s"
  title={"بوابات العمل التبعي واحد"}
  ...
  annotations={[
    {
      lines: "10",
      label: "الشارع كله",
      note: "علم واحد. مع صدق المكالمة وعدم الموافقة على المكالمة، تتوقف الحلقة قبل `run` - لا يصل النموذج أبدًا إلى التأثير الجانبي من تلقاء نفسه.",
    },
    {
      lines: "11-13",
      label: "run() is untouched",
      note: "يظل المعالج كما هو. يتم فرض الموافقة من خلال الحلقة المحيطة بها، وليس من خلال أي شيء داخل `run`.",
    },
  ]}
/>
...
<Diagram id="doc-block-14p85k" title={"مقاطعة الموافقة"} summary={"تقوم المكالمة المسورة بإيقاف الدور مؤقتًا قبل تشغيل run(). الموافقة تعيد إصدار الدور الذي يحمل مفتاح الاتصال؛ عندها فقط يحدث التأثير الجانبي."}>
...
<div class="diagram-approve">
  ...
  <div class="diagram-panel warn" data-rough>
    <strong>البوابة صحيحة، والاستدعاء لم يوافق عليه بعد</strong
  ...
  <div class="diagram-box" data-rough>
    ينقر الإنسان موافقة في الدردشة<br /><small class="diagram-muted"
      >يعيد العميل إرسال الدور مع approvedToolCalls: [approvalKey]</small
    >
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&darr;</div>
