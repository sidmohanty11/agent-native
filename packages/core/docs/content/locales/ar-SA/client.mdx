...
<div class="diagram-client">
  ...
  <div class="diagram-pill ok">useDbSync &rarr; الإعادة على التغيير</div>
</div>
```
  ...
  <div class="diagram-col">
    <div class="diagram-card" data-rough>
      ...
      ><small class="diagram-muted"
        >مصدر الحرائق: "العمل" على النجاح &rarr; الاسترداد المحلي الفوري</small
      >
    </div>
    <div class="diagram-card" data-rough>
      ...
      ><small class="diagram-muted"
        >دفع SSE، أو علامة الاستقصاء ~2s كبديل &rarr; المطبات الإصدار &rarr;
        إعادة الخلفية</small
      >
    </div>
  </div>
