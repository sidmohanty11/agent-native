...
للاطلاع على نموذج المورد والمسارات الأساسية، راجع [موارد الوكيل — Global resources](/docs/workspace#global-resources).
...
- [ ] قم بتسجيل اتصالات مساحة العمل القابلة لإعادة الاستخدام لحسابات الموفر المشتركة، ثم
      ...
      هذا الحساب
- [ ] قم بإضافة skills على مستوى مساحة العمل وتعليمات الدرابزين والموارد المرجعية للعلامة التجارية/الشركة عبر صفحة الموارد. راجع [موارد الوكيل](/docs/workspace#global-resources) للحصول على جدول نموذج الموارد الكامل وحزمة البداية الموصى بها.
