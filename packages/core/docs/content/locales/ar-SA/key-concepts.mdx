  ...
  <div class="diagram-row">
    <div class="diagram-card">
      ...
      ><small class="diagram-muted"
        >يقرأ + يكتب البيانات، وينفذ الإجراءات، ويعدل التعليمات البرمجية</small
      >
    </div>
    <div class="diagram-card">
...
(`databaseTools: "read"`)، لذلك يفحص الوكلاء بيانات التطبيق باستخدام `db-schema` /
`db-query` ويجرون عمليات الكتابة عبر actions التطبيق المكتوبة. عيّن
`databaseTools: "write"` (أو `true`) فقط لأسطح الصيانة المقصودة التي يجب أن تعرض
