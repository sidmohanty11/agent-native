...
<WireframeBlock id="doc-block-1mnhgpt">
  <Screen
    surface="desktop"
    html={
...
<Diagram id="doc-block-15vs9gk" title={"بناء ونشر وجمع"} summary={"يقوم الوكيل والمحرر المرئي بتحرير تعريف نموذج SQL-backed واحد. لم تتم مصادقة صفحة التعبئة العامة، ويتم توجيه عمليات الإرسال من جانب الخادم إلى وجهاتك."}>

```html
<div class="diagram-flow">
  <div class="diagram-col">
    <div class="diagram-node">
      موجه الوكيل<br /><small class="diagram-muted"
        >"add an NPS question"</small
      >
    </div>
    <div class="diagram-node">
      محرر مرئي<br /><small class="diagram-muted"
        >التسميات والتحقق والترتيب</small
      >
    </div>
  </div>
  ...
  <div class="diagram-panel center">
    ...
    ><small class="diagram-muted">JSON للحقول وJSON للإعدادات</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  ...
  <div class="diagram-col">
    <div class="diagram-box">
      صفحة تعبئة عامة<br /><small class="diagram-muted">unauthenticated</small>
    </div>
    <div class="diagram-box">
      responses<br /><small class="diagram-muted"
        >+ Slack / webhook / جداول</small
      >
    </div>
  </div>
</div>
...
<DataModel
  id="doc-block-qazfqj"
  title={"نموذج بيانات النماذج"}
  summary={
    "ثلاث جداول. الحقول وعمليات التكامل عبارة عن أعمدة JSON في النماذج، لذا فإن تعديلات الوكيل عبارة عن تصحيحات جراحية بدلاً من تغييرات الصفوف عبر الجدول."
  }
  entities={[
    {
      id: "forms",
      ...
      fields: [
        ...
        },
        {
          name: "fields",
          type: "json",
          note: "FormField[] — جميع أنواع الحقول",
        },
        {
          name: "settings",
          type: "json",
          note: "إعدادات النموذج — عمليات التكامل، وما إلى ذلك.",
        },
        {
          name: "status",
          type: "enum",
          note: "مسودة | نشرت | مغلق",
        },
        {
          name: "deleted_at",
          type: "datetime",
