...
<WireframeBlock id="doc-block-1ogac6">
  <Screen
    surface="desktop"
    html={
...
<Diagram id="doc-block-14toan4" title={"الرسوم المتحركة كبيانات"} summary={"التكوين هو مكون React؛ تتم قراءة كل رسم متحرك من المسار، لذا يقوم الوكيل والمخطط الزمني بتحرير نفس البيانات."}>
...
<div class="diagram-flow">
  ...
  <div class="diagram-box" data-rough>
    تركيب React<br /><small class="diagram-muted"
...
<DataModel
  id="doc-block-3960iy"
  title={"نموذج بيانات الفيديو"}
  summary={
    "SQL المؤلفات المدعومة بالإضافة إلى أنظمة التصميم والمجلدات المتداخلة، كل منها مزود بجدول مشاركات إطار العمل."
  }
  entities={[
    {
      id: "compositions",
      ...
      fields: [
        ...
        },
        {
          name: "data",
          type: "text",
          note: "التركيبة الكاملة JSON blob",
        },
        {
          name: "created_at",
          type: "text",
