...
<Diagram id="doc-block-4n71h8" title={"/migrate عبارة عن جلسة تعليمات برمجية، وليست تطبيقًا منفصلاً"} summary={"يتم إدخال المسار، URL، أو الوصف؛ يشترك التشغيل في نفس المخزن والنص وعناصر التحكم مثل أي جلسة تعليمات برمجية أخرى، ويمكن أن يصدر ملفًا محمولاً."}>
...
<div class="diagram-migrate">
  ...
  <div class="diagram-panel center" data-rough>
    ...
    ><small class="diagram-muted"
      >نفس المخزن · النص · عناصر تشغيل التنفيذ</small
    >
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-col">
    <div class="diagram-box" data-rough>تطبيق مرحل</div>
