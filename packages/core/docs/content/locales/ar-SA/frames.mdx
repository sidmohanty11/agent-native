...
<Diagram id="doc-block-s2w094" title={"ثلاثة إطارات، وقت تشغيل واحد"} summary={"تطبيقك ولوحة الوكيل متماثلان في كل إطار؛ فقط الغلاف المحيط بهم يتغير."}>

```html
<div class="diagram-frames">
  <div class="diagram-card" data-rough>
    <span class="diagram-pill accent">لوحة مضمنة</span
    ><small class="diagram-muted">يأتي مع كل تطبيق · تطوير + إنتاج</small>
  </div>
  <div class="diagram-card" data-rough>
    <span class="diagram-pill">إطار تطوير محلي</span
    ><small class="diagram-muted">تطبيق داخل iframe + لوحة + طرفية CLI</small>
  </div>
  <div class="diagram-card" data-rough>
    <span class="diagram-pill">إطار سحابي Builder.io</span
    ><small class="diagram-muted"
      >مستضاف: تعاون · تحرير مرئي · تشغيلات متوازية</small
    >
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&darr;</div>
  <div class="diagram-box" data-rough>
    نفس وقت التشغيل<br /><small class="diagram-muted"
      >تطبيقك · الإجراءات · حالة التطبيق</small
    >
  </div>
</div>
```
...
- يوفر سطح الدردشة / CLI / موارد الوكيل الكامل، بحيث يظل إدخال الوكيل قيد التشغيل
...
<Diagram id="doc-block-11eq1v0" title={"بوابة طلب الكود"} summary={"تحتاج الرسالة المكتوبة بالرمز إلى إطار قادر على البرمجة. مع اتصال واحد، يتم توجيه الطلب إلى هناك؛ بدون واحد، تشرح اللوحة أن تغييرات التعليمات البرمجية تحتاج إلى Desktop أو Builder."}>
...
يوفر [Builder.io](https://www.builder.io?utm_source=agent-native&utm_medium=docs&utm_campaign=framework&utm_content=frames) إطارًا مُدارًا يستضيف
