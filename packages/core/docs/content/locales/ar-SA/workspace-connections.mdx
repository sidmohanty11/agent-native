...
<Diagram id="doc-block-17u3697" title={"اتصل مرة واحدة، وامنح التطبيقات، وأعد استخدام بيانات الاعتماد"} summary={"يحتوي الاتصال على بيانات تعريف الموفر (ليست أسرارًا أبدًا) وبيانات الاعتماد التي تشير إلى المخزن. تفتح المنح لكل تطبيق هذه الميزة. تقرأ التطبيقات حالة استعداد واحدة."}>
  ...
  <div class="diagram-panel col" data-rough>
    ...
    <div class="diagram-box" data-rough>
      named provider account<br /><small class="diagram-muted"
        >provider, label, الحالة، النطاقات، الإعدادات &middot; never stores
        secret values</small
      >
    </div>
  ...
  entities={[
    {
      ...
      fields: [
        ...
        },
        {
          name: "provider",
          type: "string",
          note: "معرف الموفر الثابت، على سبيل المثال. الركود",
        },
        {
          name: "label",
          type: "string",
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          name: "appId",
          type: "string",
          note: "على سبيل المثال. الدماغ والتحليلات",
        },
      ],
    },
  ]}
...
<Diagram id="doc-block-1r591ch" title={"مخزن الاتصال مقابل المخزن"} summary={"يمتلك القبو القيمة السرية. يمتلك الاتصال بيانات تعريف الموفر بالإضافة إلى بيانات الاعتماد (المؤشرات). في وقت التنفيذ، يقوم التطبيق بحل المرجع من خلال اتصال ممنوح ويقرأ القيمة من المخزن."}>

```html
<div class="diagram-vault">
  <div class="diagram-panel col" data-rough>
    <span class="diagram-pill accent">مخزن الاتصالات</span>
    <div class="diagram-box" data-rough>
      provider account + metadata<br /><small class="diagram-muted"
        >الحالة، النطاقات، الإعدادات</small
      >
    </div>
    <div class="diagram-box" data-rough>
  ...
  <div class="diagram-card">
    <span class="diagram-pill">إجراء التطبيق</span
  ...
  <div class="diagram-panel col" data-rough>
    ...
    <div class="diagram-box" data-rough>
      secret value<br /><small class="diagram-muted"
        >لا تعاد أبدا إلى الوكيل أو الواجهة</small
      >
    </div>
  </div>
</div>
