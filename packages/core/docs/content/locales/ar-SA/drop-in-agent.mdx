...
هذا كل شيء. أصبح لدى المستخدم الآن وكيل قابل للتبديل في كل صفحة - مع سجل الدردشة، وعلامة تبويب موارد الوكيل، ومحطة CLI، والإدخال الصوتي، ووضع ملء الشاشة. تستمر الحالة عبر عمليات إعادة التحميل عبر `localStorage`.
