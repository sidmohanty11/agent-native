...
<WireframeBlock id="doc-block-7huabh">
  <Screen
    surface="desktop"
    html={
...
<Diagram id="doc-block-1xznnlj" title={"كيف يتدفق طلب الجدولة"} summary={"سواء قمت بالنقر فوق التقويم أو سؤال الوكيل، تتم قراءة نفس الإجراءات مباشرة من Google Calendar ثم يتم إعادة كتابتها إلى نفس العرض."}>

```html
<div class="diagram-flow">
  <div class="diagram-col">
    <div class="diagram-node">
      تنقر<br /><small class="diagram-muted"
  ...
  <div class="diagram-box">تتحدث طريقة عرض التقويم مباشرة</div>
</div>
```
...
<DataModel
  id="doc-block-s8v9za"
  title={"Calendar نموذج البيانات"}
  summary={
    "يتم تخزين البيانات غير المتعلقة بالحدث محليًا فقط - الأحداث مباشرة في Google Calendar. تستخدم روابط الحجز أعمدة خاصة بها بحيث يتم تطبيق نظام المشاركة."
  }
  entities={[
    {
      id: "booking_links",
