...
<Diagram id="doc-block-10bw7bb" title={"ثلاث طرق، حزمة واحدة"} summary={"يقوم كل من المكون الإضافي CLI، وClaude Code، والمكون الإضافي Codex بتثبيت نفس المهارتين بالإضافة إلى موصل الخطة المستضاف."}>
