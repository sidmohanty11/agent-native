...
<Diagram id="doc-block-1ue5tlf" title={"/ migration은 별도의 앱이 아닌 코드 세션입니다."} summary={"경로, URL 또는 설명이 들어갑니다. 실행은 다른 모든 코드 세션과 동일한 저장소, 기록 및 제어를 공유하며 휴대용 Dossier를 내보낼 수 있습니다."}>
...
<div class="diagram-migrate">
  ...
  <div class="diagram-panel center" data-rough>
    ...
    ><small class="diagram-muted">동일한 저장소 · 기록 · 실행 제어</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-col">
    <div class="diagram-box" data-rough>마이그레이션된 앱</div>
