...
{
  "html": "<div class=\"diagram-frames\"><div class=\"diagram-card\" data-rough><span class=\"diagram-pill accent\">임베디드 패널</span><small class=\"diagram-muted\">모든 앱에 포함 · dev + prod</small></div><div class=\"diagram-card\" data-rough><span class=\"diagram-pill\">로컬 개발 프레임</span><small class=\"diagram-muted\">iframe의 앱 + 패널 + CLI 터미널</small></div><div class=\"diagram-card\" data-rough><span class=\"diagram-pill\">Builder.io 클라우드 프레임</span><small class=\"diagram-muted\">호스팅: 협업 · 시각 편집 · 병렬 실행</small></div><div class=\"diagram-arrow diagram-muted\" aria-hidden=\"true\">&darr;</div><div class=\"diagram-box\" data-rough>동일한 runtime<br><small class=\"diagram-muted\">내 앱 · 작업 · 애플리케이션 상태</small></div></div>",
