...
<Diagram id="doc-block-1liwdej" title={"하나의 문서, 많은 편집자"} summary={"귀하와 에이전트는 모두 동일한 Yjs 파이프라인을 통해 작성합니다. SQL은 표준 저장소입니다. 로컬 파일과 Notion은 선택적 동기화 표면입니다."}>

```html
<div class="diagram-flow">
  <div class="diagram-col">
    <div class="diagram-node">
      입력합니다<br /><small class="diagram-muted">slash 메뉴, 툴바</small>
    </div>
    <div class="diagram-node">
  ...
  <div class="diagram-panel center">
    ...
    ><small class="diagram-muted">실시간, 충돌 없는 병합</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
