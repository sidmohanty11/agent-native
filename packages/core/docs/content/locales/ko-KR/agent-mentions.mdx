...
<Diagram id="doc-block-r5nrdf" title={"@-멘션이 라우팅되는 위치"} summary={"서버는 각 멘션을 유형별로 분할합니다. 사용자 정의 에이전트는 로컬에서 실행되고 연결된 에이전트는 A2A을 통해 이동합니다. 두 응답 모두 기본 에이전트의 컨텍스트로 다시 접힙니다."}>
...
<div class="diagram-mention">
  ...
  <div class="diagram-panel center" data-rough>
    <span class="diagram-pill accent">서버가 해석</span
  ...
  <div class="diagram-col">
    <div class="row">
      ...
      <div class="diagram-box">
        사용자 지정 에이전트<br /><small class="diagram-muted"
    ...
    <div class="row">
      <span class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</span>
      <div class="diagram-box">
        연결된 에이전트<br /><small class="diagram-muted"
...
전체 형식(`tools`, `delegate-default` 및 모델 재정의 포함)은 [에이전트 리소스 — Custom Agents](/docs/agent-resources#custom-agents)를 참조하세요.
