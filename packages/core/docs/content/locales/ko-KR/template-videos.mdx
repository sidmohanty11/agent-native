...
<WireframeBlock id="doc-block-a5hm32">
  <Screen
    surface="desktop"
    html={
...
<Diagram id="doc-block-uzmptu" title={"데이터로서의 애니메이션"} summary={"컴포지션은 React 구성 요소입니다. 모든 애니메이션은 트랙에서 읽혀지므로 에이전트와 타임라인이 동일한 데이터를 편집합니다."}>
...
<div class="diagram-flow">
  ...
  <div class="diagram-box" data-rough>
    React 컴포지션<br /><small class="diagram-muted"
...
<DataModel
  id="doc-block-1eyyoi5"
  title={"비디오 데이터 모델"}
  summary={
    "SQL 지원 컴포지션과 디자인 시스템, 중첩 가능한 폴더가 있으며 각각 프레임워크 공유 테이블이 있습니다."
  }
  entities={[
    {
      id: "compositions",
