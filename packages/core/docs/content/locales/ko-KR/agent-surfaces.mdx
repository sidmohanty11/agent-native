...
<Diagram id="doc-block-1rmwapd" title={"표면 스펙트럼"} summary={"하나의 작업 표면, 4개의 제품 모양 - 각각 아래의 작업을 변경하지 않고 UI를 추가합니다."}>

```html
<div class="diagram-spectrum">
  <div class="diagram-card">
    <strong>Headless</strong
    ><small class="diagram-muted">actions, 작업, 스크립트, 다른 에이전트</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-card">
    <strong>리치 채팅</strong
    ><small class="diagram-muted">작성기, 기록, 도구 카드</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-card">
    <strong>임베디드 sidecar</strong
    ><small class="diagram-muted">agent beside an existing app</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-card accent-card">
    <span class="diagram-pill accent">대부분의 UI</span
    ><strong>전체 애플리케이션</strong
    ><small class="diagram-muted">지속 화면, 데이터, 협업</small>
  </div>
</div>
<div class="diagram-base" data-rough>
  <span class="diagram-muted"
    >같은 actions · 같은 SQL · 같은 에이전트 루프</span
  >
</div>
```
...
<Endpoint id="doc-block-tkp0c2" title={"HTTP을 통해 작업 호출"} method="POST" path="/_agent-native/actions/summarize-week" summary={"HTTP에 대해 이름으로 모든 작업을 호출합니다."} request={{
...
<Diagram id="doc-block-1wr0qhh" title={"사이드카가 호스트 앱에 연결되는 방법"} summary={"플러그인은 Agent-Native 경로를 서버 측에 마운트합니다. React 사이드카는 페이지 컨텍스트 입력 및 호스트 명령 출력을 스트리밍합니다."}>
...
<div class="diagram-sidecar">
  <div class="diagram-panel">
    ...
    <div class="diagram-node">
      getContext()<br /><small class="diagram-muted">라우트 · 선택</small>
    </div>
    <div class="diagram-node">
  ...
  <div class="diagram-panel accent-panel">
    ...
    <div class="diagram-box" data-rough>
      Agent-Native 라우트<br /><small class="diagram-muted"
