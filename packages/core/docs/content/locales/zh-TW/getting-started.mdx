...
<WireframeBlock id="doc-block-response-insights-page-wireframe-zh-tw">
  <Screen
    surface="desktop"
    html={
      "<div style='min-height:520px;box-sizing:border-box;padding:28px;display:grid;grid-template-columns:minmax(220px,.72fr) minmax(360px,1.3fr);gap:20px;background:var(--wf-bg)'><aside class='wf-card' data-rough style='display:flex;flex-direction:column;gap:14px'><div class='wf-pill' data-rough>聊天串</div><div class='wf-box' data-rough style='padding:10px'><strong>Agent</strong><p class='wf-muted' style='margin:6px 0 10px'>我已儲存最新分析。</p><button class='primary' data-rough style='width:100%'>開啟回覆洞察</button></div><div class='wf-row wf-box' data-rough style='padding:8px 10px'>action 結果 -> /response-insights</div></aside><main class='wf-card' data-rough style='display:flex;flex-direction:column;gap:18px'><div style='display:flex;align-items:flex-start;justify-content:space-between;gap:16px'><div><div class='wf-pill accent' data-rough>/response-insights</div><h2 style='margin:10px 0 4px;font-size:28px'>回覆洞察</h2><p class='wf-muted' style='margin:0'>從聊天開啟的持久 app 頁面。</p></div><button class='primary' data-rough>分析最新內容</button></div><section class='wf-card' data-rough style='display:grid;grid-template-columns:1fr 1fr;gap:12px'><article class='wf-box' data-rough style='padding:12px'><strong>示範表單</strong><p class='wf-muted' style='margin:8px 0 0'>42 則回覆 / +18%</p></article><article class='wf-box' data-rough style='padding:12px'><strong>結帳調查</strong><p class='wf-muted' style='margin:8px 0 0'>17 則回覆 / 需檢視</p></article></section><section class='wf-card' data-rough style='padding:0;overflow:hidden'><div class='wf-row' data-rough='line:bottom' style='display:grid;grid-template-columns:1.1fr 2fr .8fr;gap:12px;padding:10px 12px;font-weight:600'><span>洞察</span><span>摘要</span><span>狀態</span></div><div class='wf-row' data-rough='line:bottom' style='display:grid;grid-template-columns:1.1fr 2fr .8fr;gap:12px;padding:10px 12px'><span>定價</span><span>使用者想要團隊方案。</span><span>就緒</span></div><div class='wf-row' data-rough style='display:grid;grid-template-columns:1.1fr 2fr .8fr;gap:12px;padding:10px 12px'><span>導覽流程</span><span>三個步驟造成流失。</span><span>草稿</span></div></section></main></div>"
    }
  />
</WireframeBlock>
