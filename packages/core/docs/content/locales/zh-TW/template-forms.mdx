...
<Diagram id="doc-block-128wfsc" title={"建置、發布、收集"} summary={"代理和視覺化編輯器編輯一個 SQL-backed 表單定義。公開填寫頁面未經驗證，提交內容將透過伺服器端路由到您的目的地。"}>

```html
<div class="diagram-flow">
  <div class="diagram-col">
    <div class="diagram-node">
      代理提示詞<br /><small class="diagram-muted">"add an NPS question"</small>
    </div>
    <div class="diagram-node">
      視覺化編輯器<br /><small class="diagram-muted">標籤、校驗、順序</small>
    </div>
  </div>
