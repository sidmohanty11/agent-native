...
<Diagram id="doc-block-1iq20h5" title={"Un document, plusieurs éditeurs"} summary={"Vous et l’agent écrivez tous les deux via le même pipeline Yjs. SQL est le magasin canonique ; les fichiers locaux et Notion sont des surfaces de synchronisation facultatives."}>
...
<div class="diagram-flow">
  <div class="diagram-col">
    ...
    <div class="diagram-node">
      Modifications par l’agent<br /><small class="diagram-muted"
  ...
  <div class="diagram-panel center">
    ...
    ><small class="diagram-muted">en direct, fusion sans conflit</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
...
<DataModel
  id="doc-block-wsk3tc"
  title={"Modèle de données Content"}
  summary={
    "Neuf tables dans server/db/schema.ts. documents est l’arborescence des pages ; le reste s’y rattache pour les versions, commentaires, synchronisation Notion, bases inline et partage."
  }
  entities={[
    {
      id: "documents",
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          type: "string",
          nullable: true,
          note: "synchronisation bidirectionnelle Notion",
        },
      ],
    },
    {
