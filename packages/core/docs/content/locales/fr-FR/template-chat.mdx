...
- [**Votre première fonctionnalité dans Chat**](/docs/template-chat-first-edits) — la route de chat de démarrage, annotée, ainsi qu'un guide complet pour ajouter une véritable fonctionnalité
