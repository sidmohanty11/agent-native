...
<Diagram id="doc-block-bkcqdw" title={"Un espace de travail Claude-Code, mais stocké dans SQL"} summary={"La même couche de personnalisation (instructions, compétences, mémoire, agents, tâches, MCP) sauf que chaque fichier est une ligne dans une base de données mutualisée partagée."}>
...
<div class="ws-map">
  ...
  <div class="diagram-card an">
    <span class="diagram-pill accent">Espace de travail agent-native</span
    ><small class="diagram-muted">rows in one base de données SQL</small>
    <div class="ws-rows">
...
<DataModel
  id="doc-block-c2uuu2"
  title={"Le modèle de ressources de l'espace de travail"}
  summary={
    "Une forme de ressource soutient chaque fichier d’espace de travail. Le runtime le classe par chemin et portée et résout la valeur effective lors de la lecture."
  }
  entities={[
    {
      id: "resource",
