...
<WireframeBlock id="doc-block-82wdv1">
  <Screen
    surface="desktop"
    html={
...
<Diagram id="doc-block-5e7m7" title={"Animation en tant que données"} summary={"Une composition est un composant React ; chaque animation lit une piste afin que l'agent et la chronologie éditent les mêmes données."}>
...
<div class="diagram-flow">
  <div class="diagram-col">
    <div class="diagram-node">
      Timeline<br /><small class="diagram-muted"
        >glisser, redimensionner, parcourir</small
      >
    </div>
    <div class="diagram-node">
  ...
  <div class="diagram-box" data-rough>
    Composition React<br /><small class="diagram-muted"
...
<DataModel
  id="doc-block-gcpufe"
  title={"Modèle de données vidéo"}
  summary={
    "Compositions adossées à SQL, ainsi que des systèmes de conception et des dossiers imbriqués, chacun avec une table de partage de cadre."
  }
  entities={[
    {
      id: "compositions",
      ...
      fields: [
        ...
        },
        {
          name: "data",
          type: "text",
          note: "Composition complète JSON blob",
        },
        {
          name: "created_at",
          type: "text",
