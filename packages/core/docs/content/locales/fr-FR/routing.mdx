...
<Diagram id="doc-block-chuvll" title="La mise en page sans chemin enveloppe les pages" summary={"Une disposition _app.tsx (pas de segment URL) restitue le shell partagé une fois ; les pages correspondantes s'affichent dans son <Outlet/>, de sorte que la barre latérale de l'agent ne remonte jamais lors de la navigation."}>
...
<div class="diagram-layout" data-rough>
  <div class="diagram-shell">
    ...
    ><small class="diagram-muted"
      >layout sans chemin · shell persistant + barre agent</small
    >
