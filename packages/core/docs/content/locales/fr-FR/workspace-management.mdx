...
Pour le modèle de ressource et les chemins canoniques, voir [Ressources de l'agent — Global resources](/docs/workspace#global-resources).
...
- [ ] Enregistrez les connexions d'espace de travail réutilisables pour les comptes de fournisseur partagés, puis
      ...
      ce compte
- [ ] Ajoutez skills à l'échelle de l'espace de travail, des instructions de garde-corps et des ressources de référence de marque/entreprise via la page Ressources. Voir [Ressources de l'agent](/docs/workspace#global-resources) pour le tableau complet du modèle de ressource et le pack de démarrage recommandé.
