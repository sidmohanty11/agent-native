...
<Diagram id="doc-block-1yg4clo" title={"Où une @-mention route"} summary={"Le serveur divise chaque mention par type : les agents personnalisés s'exécutent localement, les agents connectés passent par A2A — les deux réponses se replient dans le contexte de l'agent principal."}>
...
<div class="diagram-mention">
  ...
  <div class="diagram-panel center" data-rough>
    <span class="diagram-pill accent">Le serveur résout</span
  ...
  <div class="diagram-col">
    <div class="row">
      ...
      <div class="diagram-box">
        Agent personnalisé<br /><small class="diagram-muted"
    ...
    <div class="row">
      <span class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</span>
      <div class="diagram-box">
        Agent connecté<br /><small class="diagram-muted"
...
Voir [Ressources de l'agent — Custom Agents](/docs/agent-resources#custom-agents) pour le format complet (y compris `tools`, `delegate-default` et les remplacements de modèle).
...
<AnnotatedCode
  id="doc-block-aiebp8"
  title={"Un MentionProvider personnalisé"}
