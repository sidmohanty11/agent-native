...
<WireframeBlock id="doc-block-a2no0g">
  <Screen
    surface="desktop"
    html={
...
<Diagram id="doc-block-x7himh" title={"调度请求如何流动"} summary={"无论您单击日历还是询问客服人员，相同的操作都会从 Google Calendar 实时读取并写回同一视图。"}>

```html
<div class="diagram-flow">
  <div class="diagram-col">
    <div class="diagram-node">
      你点击<br /><small class="diagram-muted">拖拽、工具栏、快捷键</small>
    </div>
    <div class="diagram-node">
  ...
  <div class="diagram-col">
    ...
    <div class="diagram-box">
      SQL<br /><small class="diagram-muted">预约 · 可用时间</small>
    </div>
  </div>
...
<DataModel
  ...
  title={"日历数据模型"}
  summary={
    "仅非事件数据存储在本地 - 事件实时存储在 Google 日历中。预订链接使用 ownableColumns，因此共享系统适用。"
  }
  entities={[
    {
      id: "booking_links",
