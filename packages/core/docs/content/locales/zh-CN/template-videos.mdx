...
<WireframeBlock id="doc-block-1s0qknv">
  <Screen
    surface="desktop"
    html={
...
<Diagram id="doc-block-1o9ao3j" title={"动画作为数据"} summary={"组合物是 React 组件；每个动画都从轨道读取，因此代理和时间线编辑相同的数据。"}>
...
<div class="diagram-flow">
  ...
  <div class="diagram-box" data-rough>
    React 合成<br /><small class="diagram-muted">Remotion &lt;Player&gt;</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
...
<DataModel
  ...
  title={"视频数据模型"}
  summary={
    "SQL支持的组合以及设计系统和可嵌套文件夹，每个文件夹都有一个框架共享表。"
  }
  entities={[
    {
      id: "compositions",
