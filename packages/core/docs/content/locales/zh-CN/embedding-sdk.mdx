...
<Diagram id="doc-block-3mdiea" title={"包埋膜"} summary={"主机应用程序提供服务器端身份验证和实时页面上下文； Agent-Native 运行持久 sidecar 并通过客户端操作和主机命令到达打开的选项卡。"}>

```html
<div class="diagram-embed">
  <div class="diagram-box" data-rough>
    <strong>宿主 SaaS 应用</strong
    ><small class="diagram-muted">你的界面，你的认证</small>
  </div>
  <div class="diagram-col">
    <div class="diagram-pill accent">getContext &rarr;</div>
    <div class="diagram-pill">&larr; 客户端操作</div>
    <div class="diagram-pill">&larr; 宿主命令</div>
  </div>
  <div class="diagram-panel center" data-rough>
    <strong>Agent-Native sidecar</strong
    ><small class="diagram-muted">持久聊天 · 应用状态 · 扩展</small>
  </div>
...
<Diagram id="doc-block-13y6a1q" title={"服务器介导的浏览器会话桥"} summary={"后端工具将工作排队；注册的选项卡声明它，在实时页面上运行它，并将结果返回给代理 - 因此 backend/Slack/A2A 代理仍然可以触摸打开的选项卡。"}>

```html
<div class="diagram-bridge">
  <div class="diagram-node" data-rough>
    后端代理<br /><small class="diagram-muted">聊天 · Slack · A2A</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-box" data-rough>
  ...
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-node" data-rough>
    活动标签页接管它<br /><small class="diagram-muted">registered bridge</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
