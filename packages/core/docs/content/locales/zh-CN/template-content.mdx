...
<Diagram id="doc-block-19mhb7k" title={"一份文档，多名编辑"} summary={"您和代理都通过相同的 Yjs 管道进行写入。 SQL 是规范存储；本地文件和 Notion 是可选的同步表面。"}>
...
<div class="diagram-flow">
  ...
  <div class="diagram-panel center">
    ...
    ><small class="diagram-muted">实时、无冲突合并</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
