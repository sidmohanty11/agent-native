...
<Diagram id="doc-block-1oqeq85" title={"@提及路由的位置"} summary={"服务器按类型拆分每个提及：自定义代理在本地运行，连接的代理通过 A2A - 两个响应都折叠回主代理的上下文中。"}>
...
<div class="diagram-mention">
  ...
  <div class="diagram-panel center" data-rough>
    <span class="diagram-pill accent">服务器解析</span
  ...
  <div class="diagram-col">
    <div class="row">
      ...
      <div class="diagram-box">
        自定义代理<br /><small class="diagram-muted"
    ...
    <div class="row">
      <span class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</span>
      <div class="diagram-box">
        已连接代理<br /><small class="diagram-muted"
...
请参阅 [代理资源 — Custom Agents](/docs/agent-resources#custom-agents) 了解完整格式（包括 `tools`、`delegate-default` 和模型覆盖）。
