...
<WireframeBlock id="doc-block-response-insights-page-wireframe-zh-cn">
  <Screen
    surface="desktop"
    html={
      "<div style='min-height:520px;box-sizing:border-box;padding:28px;display:grid;grid-template-columns:minmax(220px,.72fr) minmax(360px,1.3fr);gap:20px;background:var(--wf-bg)'><aside class='wf-card' data-rough style='display:flex;flex-direction:column;gap:14px'><div class='wf-pill' data-rough>聊天线程</div><div class='wf-box' data-rough style='padding:10px'><strong>Agent</strong><p class='wf-muted' style='margin:6px 0 10px'>我已保存最新分析。</p><button class='primary' data-rough style='width:100%'>打开回复洞察</button></div><div class='wf-row wf-box' data-rough style='padding:8px 10px'>action 结果 -> /response-insights</div></aside><main class='wf-card' data-rough style='display:flex;flex-direction:column;gap:18px'><div style='display:flex;align-items:flex-start;justify-content:space-between;gap:16px'><div><div class='wf-pill accent' data-rough>/response-insights</div><h2 style='margin:10px 0 4px;font-size:28px'>回复洞察</h2><p class='wf-muted' style='margin:0'>从聊天打开的持久 app 页面。</p></div><button class='primary' data-rough>分析最新内容</button></div><section class='wf-card' data-rough style='display:grid;grid-template-columns:1fr 1fr;gap:12px'><article class='wf-box' data-rough style='padding:12px'><strong>演示表单</strong><p class='wf-muted' style='margin:8px 0 0'>42 条回复 / +18%</p></article><article class='wf-box' data-rough style='padding:12px'><strong>结账调研</strong><p class='wf-muted' style='margin:8px 0 0'>17 条回复 / 需查看</p></article></section><section class='wf-card' data-rough style='padding:0;overflow:hidden'><div class='wf-row' data-rough='line:bottom' style='display:grid;grid-template-columns:1.1fr 2fr .8fr;gap:12px;padding:10px 12px;font-weight:600'><span>洞察</span><span>摘要</span><span>状态</span></div><div class='wf-row' data-rough='line:bottom' style='display:grid;grid-template-columns:1.1fr 2fr .8fr;gap:12px;padding:10px 12px'><span>定价</span><span>用户想要团队计划。</span><span>就绪</span></div><div class='wf-row' data-rough style='display:grid;grid-template-columns:1.1fr 2fr .8fr;gap:12px;padding:10px 12px'><span>引导流程</span><span>三个步骤导致流失。</span><span>草稿</span></div></section></main></div>"
    }
  />
</WireframeBlock>
