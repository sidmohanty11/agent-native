...
<Diagram id="doc-block-110loev" title="Conecte-se uma vez, conceda aplicativos e reutilize credenciais" summary={"Uma conexão contém metadados do provedor (nunca segredos) e credentialRefs que apontam para o cofre. As concessões por aplicativo desbloqueiam-no. Os aplicativos leem um único status de prontidão."}>
  ...
  <div class="diagram-panel col" data-rough>
    ...
    <div class="diagram-box" data-rough>
      named provider account<br /><small class="diagram-muted"
        >provider, label, status, escopos, configuração &middot; never stores
        secret values</small
      >
    </div>
  ...
  entities={[
    {
      ...
      fields: [
        ...
        },
        {
          name: "provider",
          type: "string",
          note: "ID do provedor estável, por exemplo. folga",
        },
        {
          name: "label",
          type: "string",
        ...
        },
        {
          ...
          type: "json",
          nullable: true,
          note: "configuração segura e não secreta",
        },
        {
          name: "credentialRefs",
          type: "json",
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          name: "appId",
          type: "string",
          note: "por exemplo. cérebro, análise",
        },
      ],
    },
  ]}
...
<Diagram id="doc-block-ft9j7t" title={"Armazenamento de conexão vs. cofre"} summary={"O cofre possui o valor secreto. A conexão possui metadados do provedor mais credentialRefs (ponteiros). No tempo de execução, o aplicativo resolve a referência por meio de uma conexão concedida e lê o valor do vault."}>

```html
<div class="diagram-vault">
  <div class="diagram-panel col" data-rough>
    <span class="diagram-pill accent">Armazenamento de conexões</span>
    <div class="diagram-box" data-rough>
      provider account + metadata<br /><small class="diagram-muted"
        >status, escopos, configuração</small
      >
    </div>
    <div class="diagram-box" data-rough>
  ...
  <div class="diagram-card">
    <span class="diagram-pill">Ação do app</span
  ...
  <div class="diagram-panel col" data-rough>
    ...
    <div class="diagram-box" data-rough>
      secret value<br /><small class="diagram-muted"
        >nunca retornado ao agente ou à UI</small
      >
    </div>
  </div>
</div>
