...
<Diagram id="doc-block-h0fy3f" title="Um documento, muitos editores" summary={"Você e o agente escrevem através do mesmo pipeline Yjs. SQL é o armazenamento canônico; arquivos locais e Notion são superfícies de sincronização opcionais."}>
...
<div class="diagram-flow">
  ...
  <div class="diagram-panel center">
    ...
    ><small class="diagram-muted">ao vivo, merge sem conflito</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  ...
  <div class="diagram-col">
    ...
    <div class="diagram-box">
      Páginas do Notion<br /><small class="diagram-muted">pull · push</small>
    </div>
  </div>
</div>
```
...
<DataModel
  id="doc-block-u1j4ob"
  title={"Modelo de dados de conteúdo"}
  summary={
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          type: "string",
          nullable: true,
          note: "sincronização Notion bidirecional",
        },
      ],
    },
    {
