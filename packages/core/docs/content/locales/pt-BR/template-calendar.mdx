...
<WireframeBlock id="doc-block-1ys5f73">
  <Screen
    surface="desktop"
    html={
...
<Diagram id="doc-block-1im0qyx" title={"Como flui uma solicitação de agendamento"} summary={"Quer você clique no calendário ou pergunte ao agente, as mesmas ações são lidas ao vivo em Google Calendar e respondidas na mesma visualização."}>
...
<div class="diagram-flow">
  ...
  <div class="diagram-box">A visualização do calendário atualiza ao vivo</div>
</div>
```
...
<DataModel
  id="doc-block-g3ro3n"
  title="Calendar modelo de dados"
  summary={
    "Apenas dados que não sejam de eventos são armazenados localmente — os eventos vivem em Google Calendar. Os links de reserva usam ownableColumns para que o sistema de compartilhamento seja aplicado."
  }
  entities={[
    {
      id: "booking_links",
      ...
      fields: [
        ...
        },
        {
          name: "conferencing",
          type: "string",
          note: "Google Meet / Zoom / personalizado",
        },
        {
          name: "color",
          type: "string",
