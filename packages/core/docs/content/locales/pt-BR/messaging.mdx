...
| Funcionou uma vez e depois uma resposta posterior na conversa foi ignorada | É o esperado. Respostas na conversa sem menção só chegam ao agente enquanto aquela conversa tem trabalho ativo — faça outra @mention.         |
