...
<Diagram id="doc-block-r5ly0l" title={"Os pais guardam os segredos; o adaptador só executa código"} summary={"run-code constrói o módulo e executa a ponte de loopback; o adaptador recebe um módulo não secreto + limites e retorna stdout/stderr/exit."}>
...
<div class="diagram-sandbox">
  <div class="diagram-box" data-rough>
    ...
    ><small class="diagram-muted"
      >cria módulo · ponte loopback · limpeza de env · formato de saída</small
    >
  </div>
  ...
  <div class="diagram-panel center" data-rough>
    ...
    ><small class="diagram-muted"
      >processo filho local · Docker · remoto · durável</small
    >
  </div>
</div>
```
...
<FileTree
  id="doc-block-1j5ataj"
  title={"A junção do sandbox no core"}
