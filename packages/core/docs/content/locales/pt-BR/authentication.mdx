...
<Diagram id="doc-block-1rujd8s" title={"Três entradas, uma sessão"} summary={"Visitantes do navegador, clientes MCP programáticos e provedores personalizados resolvem para a mesma AuthSession que o escopo downstream lê."}>
