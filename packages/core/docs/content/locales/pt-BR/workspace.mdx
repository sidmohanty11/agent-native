...
<Diagram id="doc-block-1l7jkfd" title={"Um espaço de trabalho Claude-Code, mas armazenado em SQL"} summary={"A mesma camada de personalização — instruções, habilidades, memória, agentes, trabalhos, MCP — exceto que cada arquivo é uma linha em um banco de dados multilocatário compartilhado."}>
...
<div class="ws-map">
  ...
  <div class="diagram-card an">
    ...
    ><small class="diagram-muted">rows in one banco de dados SQL</small>
    <div class="ws-rows">
...
<DataModel
  id="doc-block-qxh1b7"
  title={"O modelo de recursos do espaço de trabalho"}
  summary={
    "Um formato de recurso suporta cada arquivo do espaço de trabalho. O tempo de execução classifica-o por caminho e escopo e resolve o valor efetivo na leitura."
  }
  entities={[
    {
      id: "resource",
