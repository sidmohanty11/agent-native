...
<Diagram id="doc-block-19rljfz" title={"Três níveis, destilados até recentes"} summary={"O prefixo mais antigo se transforma em observações datadas e uma reflexão de arco longo; apenas as voltas mais recentes permanecem textuais."}>

```html
<div class="om">
  <div class="diagram-card">
    <span class="diagram-pill">Reflexões</span
    ><small class="diagram-muted"
      >resumo de longo arco condensado do log de observações</small
    >
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&uarr;</div>
  <div class="diagram-card">
    <span class="diagram-pill accent">Observações</span
    ><small class="diagram-muted"
      >entradas densas e datadas que condensam trechos de mensagens
      brutas</small
    >
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&uarr;</div>
  <div class="diagram-card">
    <span class="diagram-pill ok">Mensagens brutas recentes</span
    ><small class="diagram-muted"
      >last N turns, kept <strong>verbatim</strong> — nunca condensados</small
    >
  </div>
</div>
```
...
<Diagram id="doc-block-udy915" title={"Dois passes de melhor esforço após uma curva limpa"} summary={"Cada operação autônoma passa abaixo de seu limite, portanto, operar o compactador a cada curva é barato. As falhas são engolidas e nunca adicionam latência."}>

```html
<div class="om-pass">
  <div class="diagram-node">
    Turno limpo termina<br /><small class="diagram-muted"
