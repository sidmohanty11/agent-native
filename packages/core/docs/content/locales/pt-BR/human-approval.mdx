...
<AnnotatedCode
  id="doc-block-ns0lug"
  title={"Bloqueando a única ação consequencial"}
  ...
  annotations={[
    {
      lines: "10",
      label: "A rua inteira",
      note: "Uma bandeira. Com isso verdadeiro e a chamada não aprovada, o loop para antes de `run` - o modelo nunca atinge o efeito colateral por conta própria.",
    },
    {
      lines: "11-13",
      label: "run() is untouched",
      note: "O manipulador permanece o mesmo. A aprovação é imposta pelo loop ao seu redor, não por nada dentro de `run`.",
    },
  ]}
/>
...
<Diagram id="doc-block-jv6i3k" title={"A interrupção da aprovação"} summary={"Uma chamada bloqueada pausa o turno antes que run() seja acionado. A aprovação reemite o turno portando a chave da chamada; só então o efeito colateral acontece."}>

```html
<div class="diagram-approve">
  <div class="diagram-box" data-rough>Agente chama send-email</div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&darr;</div>
  <div class="diagram-panel warn" data-rough>
    <strong>Gate verdadeiro, chamada ainda não aprovada</strong
  ...
  <div class="diagram-box" data-rough>
    A pessoa clica em Aprovar no chat<br /><small class="diagram-muted"
      >cliente reenvia o turno com approvedToolCalls: [approvalKey]</small
    >
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&darr;</div>
