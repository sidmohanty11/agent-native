...
<Diagram id="doc-block-125nleh" title="O que vem no shell do Chat" summary={"Uma superfície de bate-papo fina sobre o tempo de execução padrão da estrutura — ações, threads duráveis, sincronização ao vivo e autenticação — com espaço para adicionar sua própria UI."}>
...
<div class="diagram-chat">
  ...
  <div class="diagram-col right">
    <div class="diagram-box">
      Tabelas SQL centrais<br /><small class="diagram-muted"
    ...
    <div class="diagram-box">
      Better Auth<br /><small class="diagram-muted"
        >login · organizações · sessões</small
      >
    </div>
  </div>
</div>
...
- [**Automation-First Apps**](/docs/pure-agent-apps): automações, filas, scripts e workflows de agents externos sem UI de navegador
