...
- [**Seu primeiro recurso no Chat**](/docs/template-chat-first-edits) — a rota de chat inicial, anotada, além de um passo a passo completo para adicionar um recurso real
