...
<WireframeBlock id="doc-block-16tv5x5">
  <Screen
    surface="desktop"
    html={
...
<Diagram id="doc-block-xlg7n5" title={"Animação como dados"} summary={"Uma composição é um componente React; cada animação lê uma trilha para que o agente e a linha do tempo editem os mesmos dados."}>
...
<div class="diagram-flow">
  <div class="diagram-col">
    <div class="diagram-node">
      Timeline<br /><small class="diagram-muted"
        >arrastar, redimensionar, percorrer</small
      >
    </div>
    <div class="diagram-node">
  ...
  <div class="diagram-box" data-rough>
    Composição React<br /><small class="diagram-muted"
...
<DataModel
  id="doc-block-1nkt3fv"
  title={"Modelo de dados de vídeo"}
  summary={
    "Composições apoiadas por SQL, além de sistemas de design e pastas aninhadas, cada uma com uma tabela de compartilhamentos de estrutura."
  }
  entities={[
    {
      id: "compositions",
      ...
      fields: [
        ...
        },
        {
          name: "data",
          type: "text",
          note: "Blob de composição completa JSON",
        },
        {
          name: "created_at",
          type: "text",
