...
<Diagram id="doc-block-1uxomn4" title={"Três rotas, um pacote"} summary="Os plug-ins universais CLI, Claude Code e Codex instalam as mesmas duas habilidades mais o conector do Plano hospedado.">
