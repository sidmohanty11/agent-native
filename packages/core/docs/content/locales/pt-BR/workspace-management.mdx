...
Para o modelo de recursos e caminhos canônicos, consulte [Recursos do Agente — Global resources](/docs/workspace#global-resources).
...
- [ ] Registre conexões de espaço de trabalho reutilizáveis para contas de provedor compartilhadas e, em seguida,
      ...
      essa conta
- [ ] Adicione skills para todo o espaço de trabalho, instruções de proteção e recursos de referência de marca/empresa por meio da página Recursos. Consulte [Recursos do Agente](/docs/workspace#global-resources) para obter a tabela completa de modelos de recursos e o pacote inicial recomendado.
