...
<Diagram id="doc-block-10jsx4d" title={"O espectro de superfície"} summary={"Uma superfície de ação, quatro formatos de produto – cada um adiciona UI sem alterar a operação subjacente."}>

```html
<div class="diagram-spectrum">
  <div class="diagram-card">
    <strong>Headless</strong
    ><small class="diagram-muted">actions, jobs, scripts, outros agentes</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-card">
    <strong>Chat enriquecido</strong
    ><small class="diagram-muted"
      >composer, transcrição, cards de ferramentas</small
    >
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-card">
    <strong>Sidecar incorporado</strong
    ><small class="diagram-muted">agent beside an existing app</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-card accent-card">
    <span class="diagram-pill accent">maior parte do UI</span
    ><strong>Aplicação completa</strong
    ><small class="diagram-muted">telas duráveis, dados, colaboração</small>
  </div>
</div>
<div class="diagram-base" data-rough>
  <span class="diagram-muted"
    >mesmas actions · mesmo SQL · mesmo loop do agente</span
  >
</div>
```
...
<Endpoint id="doc-block-1p25am" title={"Chamando uma ação em HTTP"} method="POST" path="/_agent-native/actions/summarize-week" summary={"Invoque qualquer ação pelo nome em HTTP"} request={{
...
<Diagram id="doc-block-dejs3c" title="Como o sidecar faz a ponte para um aplicativo host" summary={"O plugin monta rotas Agent-Native no lado do servidor; o sidecar React transmite o contexto da página e sai dos comandos do host."}>
