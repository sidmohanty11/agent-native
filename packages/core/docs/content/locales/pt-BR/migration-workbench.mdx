...
<Diagram id="doc-block-1d1h1x6" title={"/migrate é uma sessão de código, não um aplicativo separado"} summary={"Um caminho, URL, ou descrição entra; a execução compartilha o mesmo armazenamento, transcrição e controles que qualquer outra sessão de código e pode emitir um dossiê portátil."}>
...
<div class="diagram-migrate">
  ...
  <div class="diagram-panel center" data-rough>
    ...
    ><small class="diagram-muted"
      >mesmo store · transcrição · controles de execução</small
    >
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-col">
    <div class="diagram-box" data-rough>App migrado</div>
