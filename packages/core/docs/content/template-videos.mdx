...
<Diagram id="doc-block-akc8td" title="Animation as data" summary={"A composition is a React component; every animation reads from a track so the agent and the timeline edit the same data."}>

```html
<div class="diagram-flow">
  <div class="diagram-col">
    <div class="diagram-node">
      Timeline<br /><small class="diagram-muted">drag, resize, scrub</small>
    </div>
    <div class="diagram-node">
  ...
  <div class="diagram-box" data-rough>
    React composition<br /><small class="diagram-muted"
...
<DataModel
  id="doc-block-mpte5r"
  title="Video data model"
  summary="SQL-backed compositions plus design systems and nestable folders, each with a framework shares table."
  entities={[
    {
      id: "compositions",
      name: "compositions",
